...
const FRAMEWORK_DOCUMENT_PATHS = {
  et: path.join(process.cwd(), "docs", "legal", "SotsiaalAI_raamdokument_extracted.txt"),
  en: path.join(process.cwd(), "docs", "legal", "SotsiaalAI_raamdokument_extracted.en.txt"),
  ru: path.join(process.cwd(), "docs", "legal", "SotsiaalAI_raamdokument_extracted.ru.txt")
};
...
function isIgnoredStandaloneLabel(line) {
  ...
  return text === "väli" || text === "vĆ¤li" || text === "sisu";
}
