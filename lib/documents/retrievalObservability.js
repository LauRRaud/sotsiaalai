...
const CACHE_TTL_MS = Number(process.env.AGENT_RETRIEVAL_DEBUG_TTL_MS || 2 * 60 * 60 * 1000)
const CACHE_MAX_ENTRIES = Number(process.env.AGENT_RETRIEVAL_DEBUG_MAX_ENTRIES || 500)
