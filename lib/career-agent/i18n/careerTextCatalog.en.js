export const careerTextCatalogEn = Object.freeze({
  ...
  questions: {
    intake_reason: {
      prompt: "Describe your current situation and what you would most like clarity or help with right now.",
    },
    ...
    profile_cv_available: {
      prompt:
        "Do you already have a CV? Add it as an attachment with the paperclip icon to the left of the message field.",
    },
    profile_background_summary: {
      prompt:
        "If you added a CV, tell me what you still want to add or highlight about yourself before I put together a profile summary. If you do not have a CV, briefly describe your recent work or study background and where you would like to move next.",
    },
