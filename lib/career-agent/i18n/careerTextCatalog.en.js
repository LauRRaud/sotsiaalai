export const careerTextCatalogEn = Object.freeze({
  ...
  questions: {
    ...
    consent_profile_storage: {
      prompt:
        "Do you agree that your career profile is stored so guidance can continue consistently? Please answer yes or no.",
    },
    consent_job_matching: {
      prompt:
        "Do you agree that your profile may be used to assess fit for job or direction suggestions? Please answer yes or no.",
    },
    consent_document_generation: {
      prompt:
        "Do you agree that your information may be used to draft documents? Please answer yes or no.",
    },
    consent_testing: {
      prompt:
        "Do you agree to testing or assessment-like activities if they turn out to be necessary? Please answer yes or no.",
    },
    consent_minor_guardian: {
      prompt:
        "Is the consent of a parent or guardian for testing available? Please answer yes or no.",
    },
    ...
    confirm_profile_approved: {
      prompt:
        "Is this profile summary accurate and detailed enough for us to continue? Please answer yes or no.",
    },
    self_strengths: {
