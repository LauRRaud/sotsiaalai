export const careerQuestionTextEn = Object.freeze({
  questions: {
    intake_reason: {
    ...
    contact_preferred_channel: {
      prompt: "Which channel is most convenient for you to continue the guidance in?",
      options: {
        chat: "Chat here",
        email: "Email",
        phone: "Phone",
    ...
    consent_profile_storage: {
      prompt: "Do you agree that your career profile is stored so guidance can continue consistently?",
    },
    consent_job_matching: {
      prompt: "Do you agree that your profile may be used to assess fit for job or direction suggestions?",
    },
    consent_document_generation: {
      prompt: "Do you agree that your information may be used to draft documents?",
    },
    consent_testing: {
      prompt: "Do you agree to testing or assessment-like activities if they turn out to be necessary?",
    },
    consent_minor_guardian: {
      prompt: "Is the consent of a parent or guardian for testing available?",
    },
    confirm_profile_approved: {
      prompt: "Is this profile summary accurate and detailed enough for us to continue?",
    },
    self_strengths: {
