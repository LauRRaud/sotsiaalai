export const careerTextCatalogEt = Object.freeze({
  ...
  direction: {
    ...
    desiredTargetRationale: "See suund põhineb sinu enda kirjeldatud eesmärgil.",
  },
  errors: {
  ...
  questions: {
    intake_reason: {
      prompt: "Kirjelda lühidalt, mille osas sa soovid oma järgmiste töö- või õpisammude kohta abi või selgust.",
    },
    identity_display_name: {
      prompt: "Mis nime all soovid, et ma sind kõnetaksin?",
    },
    identity_age_group: {
    ...
    profile_cv_available: {
      prompt:
        "Profiili koostamiseks palun laadi oma CV manusesse, kui see on olemas. Kui sul on CV olemas, lisa see siit. Kui CV-d praegu ei ole, vasta lihtsalt ei ja liigume edasi.",
    },
    profile_background_summary: {
      promptWithCv:
        "Kirjelda palun, mida soovid enda kohta veel kindlasti lisada või rõhutada, enne kui koostan profiili kokkuvõtte.",
      promptWithoutCv:
        "Kirjelda lühidalt oma senist töö- või õpikogemust ja seda, kuhu tahaksid järgmisena liikuda.",
    },
  ...
  summary: {
    ...
    labels: {
      ...
      familiarPath: "Senise tausta põhjal sobib ka",
      firstStep: "Esimene praktiline samm",
      studyPlaces: "Kus seda õppida",
  ...
  profile: {
    ...
    draft: "Sinu lisatud märkus",
  },
  direction: {
    defaultTitle: "Võimalik suund",
    missingTitle: "Puudujäägid",
    studyTitle: "Kus seda õppida",
  },
  option: {
    defaultTitle: "Võimalus",
    score: "Skoor",
