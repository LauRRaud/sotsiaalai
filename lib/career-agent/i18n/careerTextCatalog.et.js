export const careerTextCatalogEt = Object.freeze({
  ...
  questions: {
    ...
    consent_minor_guardian: {
      prompt:
        "Kas lapsevanema või eestkostja nõusolek testimiseks on olemas?",
    },
    ...
    profile_background_correction: {
      prompt:
        "Palun täpsusta või paranda seda kokkuvõtet. Lisa julgelt puuduv kogemus, oskused, piirangud või see, kuhu tegelikult soovid jõuda.",
    },
    confirm_profile_approved: {
      prompt:
        "Kas see profiili kokkuvõte on õige ja piisavalt täpne, et saaksime edasi liikuda?",
    },
    self_strengths: {
