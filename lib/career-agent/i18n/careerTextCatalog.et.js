export const careerTextCatalogEt = Object.freeze({
  ...
  questions: {
    ...
    consent_profile_storage: {
      prompt:
        "Kas nõustud, et sinu karjääriprofiili hoitakse, et nõustamist järjepidevalt jätkata? Palun vasta jah või ei.",
    },
    consent_job_matching: {
      prompt:
        "Kas nõustud, et sinu profiili kasutatakse töö- või suunasoovituste sobivuse hindamiseks? Palun vasta jah või ei.",
    },
    consent_document_generation: {
      prompt:
        "Kas nõustud, et sinu infot kasutatakse dokumentide mustandite koostamiseks? Palun vasta jah või ei.",
    },
    consent_testing: {
      prompt:
        "Kas nõustud testimise või hindamislaadsete tegevustega, kui need osutuvad vajalikuks? Palun vasta jah või ei.",
    },
    consent_minor_guardian: {
      prompt:
        "Kas lapsevanema või eestkostja nõusolek testimiseks on olemas? Palun vasta jah või ei.",
    },
    profile_background_summary: {
      prompt:
        "Kirjelda lühidalt oma senist töö- või õpikogemust ja seda, kuhu soovid järgmisena jõuda.",
    },
    confirm_profile_approved: {
      prompt:
        "Kas see profiili kokkuvõte on õige ja piisavalt täpne, et saaksime edasi liikuda? Palun vasta jah või ei.",
    },
    self_strengths: {
