...
function hasExplicitContactSignal(profile) {
...
export function buildStateContext(profile, runtime = {}) {
  ...
  return {
    ...
    contact: {
      ...
      hasExplicitContactSignal: hasExplicitContactSignal(profile),
    },
...
export function isStateSatisfied(state, profile, runtime = {}) {
  ...
  switch (state) {
    ...
    case CAREER_AGENT_STATES.PARSE_PROFILE:
      return context.runtime.profileParsed || context.coverage.hasCvOrProfileSignals;
