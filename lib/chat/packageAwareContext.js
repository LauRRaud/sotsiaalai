...
export function buildPackageAwareContext(sourcePackages = [], options = {}) {
  ...
  const conditionGuardrail = [
    ...
    "- Kui kasutaja küsib teenuse tingimusi, aga eraldi eligibility/tingimused sektsioon on tühi, ära ütle automaatselt, et tingimusi ei saa välja tuua. Anna kinnitatud teenuse sihtrühm, eesmärk, sisu, taotlemise viis ja õiguslik alus description, application ja legal_basis sektsioonidest. Märgi ainult kitsalt, millised spetsiifilised eligibility kriteeriumid, tasud või tähtajad allikates puuduvad."
  ].join("\n");
