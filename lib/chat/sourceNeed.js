...
export function shouldUseExternalSourcesForTurn(message = "", options = {}) {
  ...
  const asksForRuleOrProcedure =
    /(kas|mis|mida|millal|kuidas|kuhu|kellele|kes|milline|tingimus|tingimused|noue|nouded|tahtaeg|summa|maar|maara|kontakt|vorm|saab|voib|peab|tuleb|tohib|kohustus|oigus|menetlus|leia|otsi|loetle|nimeta|koik|kõik|olemas|apply|application|eligible|requirement|deadline|amount|contact|form)/.test(text);
