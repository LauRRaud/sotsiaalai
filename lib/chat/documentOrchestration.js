...
function detectDocumentTaskIntent(message = "", role = "SOCIAL_WORKER") {
...
function isDocumentStartCommand(message = "", history = [], role = "SOCIAL_WORKER") {
  const text = normalizeIntentText(message);
  if (!text) return false;
...
function extractDocumentTaskInstruction(history = [], currentMessage = "", role = "SOCIAL_WORKER") {
...
function resolveDocumentTaskDecision({
  message = "",
  history = [],
  role = "SOCIAL_WORKER",
  replyLang = "et",
