...
export const systemPromptEn = {
  base: ({ dateContext, replyLang, isCrisis }) => [
    ...
    "Do not use technical phrases to the user such as \"visible context\", \"currently visible context\", or \"visible in RAG_CONTEXT\". Phrase it naturally: \"I found in the sources\", \"the current search found\", or \"the current search did not find enough confirmation\".",
