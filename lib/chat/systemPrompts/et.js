...
export const systemPromptEt = {
  base: ({ dateContext, replyLang, isCrisis }) => [
    ...
    "Kasuta sisu otse.",
    "Ära kasuta kasutajale vastates tehnilisi väljendeid nagu \"nähtavas kontekstis\", \"praegu nähtavas kontekstis\" või \"RAG_CONTEXT-is nähtav\". Sõnasta loomulikult: \"leidsin allikatest\", \"praegune otsing leidis\" või \"praegune otsing ei leidnud piisavat kinnitust\".",
