...
import {
  buildQuestionPlan,
  isQuestionPlanResourceDiscovery
} from "@/lib/chat/questionPlanner";
...
function buildResourceDiscoveryInstruction(replyLang = "et") {
  if (replyLang === "en") {
    return [
      ...
      "Prefer organization, material, guideline, contact, and resource sources from RAG_CONTEXT.",
  ...
  if (replyLang === "ru") {
    return [
      ...
      "Отдавай предпочтение источникам об организациях, материалах, руководствах, контактах и ресурсах из RAG_CONTEXT.",
  ...
  return [
    ...
    "Eelista RAG_CONTEXTis organisatsiooni-, materjali-, juhendi-, kontakti- ja ressursiallikaid.",
...
export async function assembleRetrievalContext({
  ...
  const questionPlanForcesRag = isQuestionPlanResourceDiscovery(questionPlan) && questionPlan.needs_rag === true;
