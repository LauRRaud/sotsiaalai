...
function buildLegalCitationInstruction(replyLang = "et") {
  if (replyLang === "en") {
    return [
      ...
      "When the user asks which Social Welfare Act provisions regulate subsistence benefit, treat SHS § 131-135 as the core section if the sources confirm them. Do not include amendment provisions such as 'Social Welfare Act amendment' unless the user asks about changes.",
  ...
  return [
    ...
    "Kui kasutaja küsib, millised Sotsiaalhoolekande seaduse sätted reguleerivad toimetulekutoetust, käsitle põhiosana SHS §-e 131-135, kui allikad neid kinnitavad. Ära lisa muutmissätteid nagu \"Sotsiaalhoolekande seaduse muutmine\", kui kasutaja ei küsi muudatusi.",
