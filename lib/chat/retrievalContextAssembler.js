...
function buildThematicSynthesisInstruction(replyLang = "et") {
  if (replyLang === "en") {
    return [
      ...
      "Combine journal articles, studies, statistics and guides when the retrieved context supports them.",
  ...
  return [
    ...
    "Kombineeri ajakirjaartikleid, uuringuid, statistikat ja juhendeid, kui leitud kontekst neid toetab.",
...
export async function assembleRetrievalContext({
  ...
  const extraSystemInstructions = [
    ...
    ...(thematicSynthesisQuestion ? [buildThematicSynthesisInstruction(replyLang)] : []),
