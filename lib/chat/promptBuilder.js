...
Toetu RAG-kontekstis olevatele usaldusväärsetele allikatele.
...
Toetu RAG-kontekstis toodud allikatele (seadus, ametlikud juhendid, artiklid, metoodikad jne).
Erista vastuses:
...
function groundingPolicy(includeSources) {
  ...
  return [
    "Lähtudes vastamisel ette antud kontekstist ja allikatest.",
    "Ära esita oletusi faktina, kui kontekst neid ei toeta; kui infot napib, ütle see ausalt.",
