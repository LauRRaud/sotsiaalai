...
function groundingPolicy() {
  return [
    ...
    "Kui kasutad mõnd teoreetilist mõistet, raamistust või põhimõtet, peab see esinema vähemalt ühes ette antud materjalis; ära loo uusi teooriaid või kategooriaid, mida materjal ise ei kirjelda.",
    "Ära tee materjali põhjal laiu üldistusi ega järeldusi kujul 'sellised lahendused toimivad kõige paremini siis, kui…' või 'sotsiaaltöö vaatenurgast tähendab see, et…', kui materjal ise sellist üldistust ei esita; jää konkreetse kirjelduse tasandile.",
    ...
    "Kasuta materjalides sisalduvat ajastust; vajadusel maini seda neutraalselt (näiteks viita artikli ilmumise aastale).",
    "Kui materjal sisaldab selget aastaarvu, võid seda kasutada ajaraamina ja seostada suhtelised ajaväljendid (näiteks “eelmisel suvel”, “toona”) selle aastaga. Kui sellist ajaraami ei ole, ära teisenda suhtelisi ajaväljendeid konkreetseteks aastaarvudeks, vaid kasuta sama ajavormi, mis on materjalis.",
    ...
    "Ära lisa omapoolseid selgitavaid sulgudes kommentaare (näiteks “(ajastu kontekstis: …)”).",
    "Kui kasutaja palub luua uue idee, teenuse, mudeli või kontseptsiooni, võid pakkuda loomingulisi ja innovaatilisi ettepanekuid. Sellisel juhul hoia selgelt eraldi see, mis pärineb materjalidest, ja see, mis on sinu loodud uus idee, ning ära esita uut ideed olemasoleva faktina.",
...
/** =========================================================
 *   VESTLUSMUDelI PӘRING – INPUT KOOSTAMINE
 * ========================================================= */
