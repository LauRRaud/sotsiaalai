...
function groundingRule() {
  return [
    ...
    "If the user asks what their municipality or local government must do but has not stated the municipality, explain the national rule first and ask for the municipality before giving local contacts, forms, amounts, or procedures.",
