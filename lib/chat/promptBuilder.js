    ...
    return {
      ...
      noContext: serverT(
        ...
        isWorker
          ...
          : "Я пока не нашёл точного ответа. Опишите, пожалуйста, ситуацию чуть подробнее и укажите хотя бы город или волость. Не добавляйте личный код и точный адрес."
      ),
    ...
    return {
      ...
      noContext: serverT(
        ...
        isWorker
          ...
          : "I could not find an exact answer right now. Please describe your situation a bit more and include at least your municipality or city. Do not include a personal ID number or exact address."
      ),
  ...
  return {
    ...
    noContext: serverT(
      ...
      isWorker
        ...
        : "Ma ei leidnud praegu täpset vastust. Kirjelda palun oma olukorda veidi täpsemalt ja lisa vähemalt vald või linn. Ära lisa isikukoodi ega täpset aadressi."
    ),
...
function buildBaseSystemPrompt({ isCrisis = false, replyLang = "et" }) {
  return [
    ...
    "Start with what it is or was, what it is or was for, and briefly how it works or worked.",
    ...
    isCrisis
      ? "If there is immediate danger, keep the answer short and direct the user to call 112."
      : null
  ]
    .filter(Boolean)
    .join("\n");
