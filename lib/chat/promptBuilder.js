...
function groundingPolicy() {
  return [
    ...
    "Kui kirjeldatud roll, ametikoht, konkreetne projekt või asutus on seotud selgelt piiritletud ajaga, kirjelda seda minevikuvormis („oli”, „töötas”, „juhtis”) või koos aastaga. Ära eelda ega ütle, et sama roll kehtib ka praegu, kui tekst seda otsesõnu ei väida.",
    "Olevikuvormi („on”) kasuta eelkõige ideede, kontseptsioonide ja ajas püsivate omaduste kirjeldamiseks (näiteks inimese eriala, väärtushoiakud, üldised põhimõtted). Kui loos kirjeldatakse konkreetset töökohta või teenust, mille kestmist ei kinnitata, eelista minevikuvormi („oli”, „tegutses”, „pakkus teenust”).",
    "Kui praeguse seisu kohta infot ei ole, võid seda lühidalt öelda (näiteks „sellest kirjeldusest ei selgu, kas ta praegu samas rollis jätkab”); ära paku oletusi ega jäta muljet, et tead tänast seisu.",
...
function profileAndConceptPolicy() {
  return [
    ...
    "Kui materjal võimaldab, koosta sisuline lühiprofiil: alusta 2–4 lausest kokkuvõttega, seejärel too 2–6 olulisemat detaili (näiteks rollid, tegevusvaldkonnad, tüüpilised olukorrad), vajadusel ajaorientiiriga (näiteks „2012–2018 töötas …”, „sel ajal tegutses …”).",
    ...
    "Kui eristad ideed või kontseptsiooni ja konkreetset näidet (näiteks üldine teenusepõhimõte versus üks konkreetne asutus, projekt või algatus, kus seda põhimõtet rakendati), selgita ideed olevikus, kuid konkreetset näidet minevikuvormis, kui tekst ei kinnita, et see praegu tegutseb.",
