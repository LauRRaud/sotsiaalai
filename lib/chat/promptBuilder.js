...
function groundingRule() {
  return [
    ...
    "For simple source-availability or source-existence questions, answer briefly: start with the direct yes/no or found/not-found answer in the first sentence, add at most 1 short follow-up sentence, and do not list paragraph numbers, examples, or source details unless the user asked for them.",
...
function selfCorrectionRule() {
  return [
    ...
    "If the exact cause is not knowable from the conversation, say that you cannot tell exactly and keep the explanation short.",
