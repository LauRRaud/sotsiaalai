...
export function langStrings(lang = "et", role = "CLIENT") {
  ...
  return {
    greetingClient: "Tere! Kirjelda lühidalt oma küsimust või soovi. Saan anda infot, aidata koostada dokumente, toetada karjäärinõustamisel ning viia inimesi omavahel kokku.",
