...
export function toResponsesInput({
  ...
  const todayContext = `Tänane kuupäev on: ${new Date().toLocaleDateString(
    "et-EE",
  )}. Kasutaja jutust pärit ajaviiteid (näiteks „praegu”, „eelmisel aastal”) mõtesta selle kuupäeva suhtes. Materjalides (<context>) esinevaid ajaviiteid käsitle nende materjalide ilmumisaja ja konteksti järgi, mitte tänase kuupäeva järgi ümber tõlgendades.`;
