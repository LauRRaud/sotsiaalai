...
// Tagastab tänase kuupäeva et-EE formaadis ja Tallinna ajavööndis (nt "27.11.2025").
// See on mõeldud ainult mudeli sisemiseks ajakontekstiks, mitte kasutajale väljaütlemiseks.
...
function groundingPolicy() {
  return [
    ...
    "Ära lisa oma pealt koostöö- või rakendamissoovitusi (näiteks kellega ja kuidas koostööd teha), kui neid pole materjalis kirjeldatud või kasutaja seda selgelt ei küsi.",
