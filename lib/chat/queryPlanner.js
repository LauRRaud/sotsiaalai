...
export function buildResourceDiscoveryFilters(audienceFilter = null) {
  return {
    ...(audienceFilter || {}),
    $or: [
      {
...
export function buildLifeSituationGuidanceFilters(audienceFilter = null) {
  return {
    ...(audienceFilter || {}),
    $or: [
      {
...
export function buildComparisonFilters(audienceFilter = null) {
  return {
    ...(audienceFilter || {}),
    $or: [
      {
...
export function buildResourceDiscoveryQueries(ragQueries = [], baseQuery = "") {
...
export function buildLifeSituationGuidanceQueries(ragQueries = [], baseQuery = "", questionPlan = {}) {
  const normalizedQueries = normalizeRagQueryEntries(ragQueries);
  const base = String(baseQuery || "").trim();
...
export function buildComparisonQueries(ragQueries = [], baseQuery = "", questionPlan = {}) {
  const normalizedQueries = normalizeRagQueryEntries(ragQueries);
  const base = String(baseQuery || "").trim();
