...
function isComparisonQuestion(text = "") {
  return /\b(vordle|vordlus|erista|eristada|erinevus|erinevad|mis vahe)\b/.test(text) &&
    /\b(teenus|toetus|koduteenus|isikliku abistaja|tugiisik|lapsehoid|uldhooldus|sotsiaaltransport)\b/.test(text);
}
