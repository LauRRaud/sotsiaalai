const labels = {
  ...
  phone: "telefon",
  prioritize: "vajab prioriseerimist",
  "processes.duplicate_entry": "dubleeriv sisestus tööprotsessis",
  "processes.high_value_loss": "oluline töö jääb madala väärtusega tegevuste taha",
  "processes.single_entry_needed": "vaja üht sisestuskohta",
  "processes.switching_load_high": "töövoogude vahel liikumise koormus on kõrge",
  ...
  stable: "stabiilne",
  "starter_support.mentor_needed": "vaja mentori tuge",
  "starter_support.missing_support": "puuduv tööalane tugi",
  "starter_support.not_to_carry_alone": "olukorda ei peaks üksi kandma",
  ...
  yellow: "kollane",
  red: "punane",
  insufficient_data: "andmeid ei ole veel piisavalt",
  manageable: "hallatav",
  support_available: "tugi on olemas",
  organizational_support: "vajab organisatsiooni tuge",
  needs_agreement: "vajab kokkulepet",
  needs_attention: "vajab tähelepanu",
  needs_clearer_support_plan: "vajab selgemat toeplaani",
  needs_clarification: "vajab täpsustamist",
  needs_organizational_change: "vajab töökorralduslikku muutust",
  needs_reorganization: "vajab töö ümberkorraldamist",
  needs_simplification: "vajab lihtsustamist",
  needs_urgent_support_agreement: "vajab kiiret toe kokkulepet",
  needs_workflow_clarification: "vajab töövoo täpsustamist"
};
