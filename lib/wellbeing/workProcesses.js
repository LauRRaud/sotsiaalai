...
function buildOutputSummary(fields, result) {
  const processMap = [
    "Tööprotsessi kaart",
    "",
    `Analüüsi fookus: ${fields.analysisFocus || "täpsustamisel"}.`,
    "Kategooriad:",
    ...
    `Tööprotsessi mõju: ${fields.processImpact || "täpsustamisel"}.`
  ].join("\n");
  ...
  const documentationSimplification = [
    ...
    "",
    `Dubleerimise tase: ${fields.documentationDuplication || "täpsustamisel"}.`,
  ...
  const managerMemo = [
    ...
    `Fookus: ${fields.analysisFocus || "täpsustamisel"}.`,
