...
const HELP_SIGNAL_RULES = Object.freeze([
  ["TRANSPORT", /\b(transport|sõit|soit|arsti juurde|liikumisabi|saatmine|teenusele jõudmine|teenusele joudmine)\b/iu],
  ["DAILY_TASKS", /\b(poes käimine|poes kaimine|ostud|igapäevased toimingud|igapaevased toimingud|asjaajamine)\b/iu],
  ["HOME_HELP", /\b(koduabi|kodune abi|majapidamine|koristamine|kodune toimetulek)\b/iu],
  ...
  ["ADMIN_FORM_HELP", /\b(avaldus|vorm|dokumendid|dokumendi|blankett|asjaajamine)\b/iu]
]);
