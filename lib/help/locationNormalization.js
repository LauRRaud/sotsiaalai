...
export function extractPlaceFromText(input = {}) {
...
export function isHighConfidenceMunicipalityResolution(result = null) {
...
export function normalizeMunicipalityCandidateText(value = "") {
