...
export async function findCurrentWorkerFrameworkAcceptance(userId) {
...
export async function ensureFrameworkAcceptanceDocumentRecord({ acceptance, user, locale = "en" }) {
  if (!acceptance?.id || !user?.id) return null;
