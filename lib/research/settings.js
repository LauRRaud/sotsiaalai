...
const PROFILE_LIGHT = {
  ...
  maxOutputTokens: toInt(process.env.RESEARCH_MAX_OUTPUT_TOKENS_LIGHT, 550, 100, 3000),
...
const PROFILE_STANDARD = {
  ...
  maxOutputTokens: toInt(process.env.RESEARCH_MAX_OUTPUT_TOKENS, 900, 120, 5000),
...
export function resolveResearchModel() {
  return process.env.RESEARCH_MODEL || DEFAULT_MODEL || "gpt-5.4-mini";
}
