...
const DEFAULT_WORKER_LEASE_MS = Number(process.env.RESEARCH_WORKER_LEASE_MS || 10 * 60 * 1000);
const DEFAULT_WORKER_MAX_ATTEMPTS = Number(process.env.RESEARCH_WORKER_MAX_ATTEMPTS || 3);
