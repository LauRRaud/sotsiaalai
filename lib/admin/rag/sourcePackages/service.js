...
export const SOURCE_PACKAGE_ACTIONS = new Set(["mark_reviewed", "archive", "restore_active", "recompute", "accept_gap"]);
...
function wrongCollectionId(row = {}) {
  return sourceMembership(row).some(source => {
    if (source.source_type === "kov_regulation") return source.collection_id && source.collection_id !== "kov_regulations";
