export const ORGANIZATION_SCHEMA_VERSION = "organization-source-v1";
export const ORGANIZATION_COLLECTION_ID = "organizations";
export const ORGANIZATION_CORE_FILE_NAMES = Object.freeze({
...
export function collectOrganizationDataItems(dataPayload = {}) {
  return [
    dataPayload,
...
export function collectOrganizationReferencedSourceKeys(dataPayload = {}) {
...
export function buildOrganizationChunkMetadataPreview(ragPayload = {}) {
  return {
