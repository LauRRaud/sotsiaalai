...
import { ORGANIZATION_FILE_ROLE_META, resolveOrganizationFileKeyFromParam } from "./shared";
...
export function resolveAbsoluteOrganizationPath(storagePath) {
...
export function resolveOrganizationUploadAccept(paramRole) {
  const fileKey = resolveOrganizationFileKeyFromParam(paramRole);
  return fileKey ? ORGANIZATION_FILE_ROLE_META[fileKey].accept : ORGANIZATION_FILE_ROLE_META.attachment.accept;
}
