const ALERT_MIN_CHECKOUT_CREATE_RATE_PCT = Number(process.env.PAYMENT_ALERT_MIN_CHECKOUT_CREATE_RATE_PCT || 80);
const ALERT_MIN_PAID_FROM_CHECKOUT_RATE_PCT = Number(process.env.PAYMENT_ALERT_MIN_PAID_FROM_CHECKOUT_RATE_PCT || 35);
const ALERT_MAX_CALLBACK_PENDING_RATE_PCT = Number(process.env.PAYMENT_ALERT_MAX_CALLBACK_PENDING_RATE_PCT || 40);
const ALERT_MAX_WEBHOOK_TECH_ERROR_COUNT = Number(process.env.PAYMENT_ALERT_MAX_WEBHOOK_TECH_ERROR_COUNT || 3);
const ALERT_MAX_WEBHOOK_TECH_ERROR_RATE_PCT = Number(process.env.PAYMENT_ALERT_MAX_WEBHOOK_TECH_ERROR_RATE_PCT || 10);
const ALERT_MIN_SAMPLE_SIZE = Number(process.env.PAYMENT_ALERT_MIN_SAMPLE_SIZE || 8);
