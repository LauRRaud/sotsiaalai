...
const titleClassName =
  `rooms-page-title ${glassPageTitleClassName} w-full max-w-full max-[768px]:!text-[clamp(2.2rem,8.7vw,3rem)] max-[768px]:!leading-[1.06] max-[768px]:!mt-0 max-[768px]:!mb-0 max-[768px]:![--glass-mobile-title-inline-pad:clamp(4.2rem,17vw,5.4rem)]`;
