const CHAT_LAYOUT_BASE_VARS = Object.freeze({
  ...
  "--chat-window-bottom-gap": "-4.2rem",
  "--chat-window-main-bottom-overlap": "clamp(-5.2rem, -9vh, -3.6rem)",
  "--chat-window-fade-top": "clamp(1.25rem, 3.1vh, 2.15rem)",
  "--chat-window-fade-bottom": "clamp(2.45rem, 6vh, 3.85rem)",
  "--chat-window-shift-y": "clamp(1.05rem, 2.65vh, 2.05rem)",
  "--chat-window-main-offset": "0rem",
  "--chat-scroll-down-offset": "-0.9rem",
  "--chat-content-top-offset": "5.2rem",
  "--chat-content-spacer": "7.4rem",
  "--chat-content-bottom-spacer": "0.35rem",
  "--chat-window-scroll-top-fade-start": "0.68rem",
  "--chat-window-scroll-top-fade-mid": "1.35rem",
  "--chat-window-scroll-top-fade-end": "2.35rem",
...
const CHAT_LAYOUT_DESKTOP_FOCUS_OVERRIDES = Object.freeze({
  ...
  "--chat-window-top-offset": "clamp(2.15rem, 4.6vh, 3.25rem)",
  ...
  "--chat-window-fade-top-focus": "clamp(0.85rem, 1.9vh, 1.35rem)",
  "--chat-window-scroll-top-fade-start-focus": "0.38rem",
  "--chat-window-scroll-top-fade-mid-focus": "0.78rem",
  "--chat-window-scroll-top-fade-end-focus": "1.35rem",
  "--chat-window-fade-bottom-focus": "clamp(2.45rem, 6vh, 3.85rem)",
