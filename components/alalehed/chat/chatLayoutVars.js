const CHAT_LAYOUT_BASE_VARS = Object.freeze({
  ...
  "--chat-send-btn-shift-x": "0.06rem",
  "--chat-send-btn-shift-y": "0.04rem",
  "--chat-input-max-w":
...
const CHAT_LAYOUT_MOBILE_VARS = Object.freeze({
  ...
  "--chat-window-pad-bottom": "calc(env(safe-area-inset-bottom, 0px) + 3.65rem)",
  "--chat-window-top-safe": "3.35rem",
  "--chat-window-bottom-gap": "0.45rem",
  "--chat-window-shift-y": "clamp(1.5rem, 4.6vh, 2.35rem)",
  ...
  "--chat-window-top-text-fade-extra": "3.05rem",
  "--chat-window-scroll-top-fade-start": "0.62rem",
  "--chat-window-scroll-top-fade-mid": "1.22rem",
  "--chat-window-scroll-top-fade-end": "2.05rem",
  "--chat-window-fade-bottom": "clamp(3.2rem, 9vh, 4.9rem)",
  "--chat-scroll-down-offset": "-2.15rem",
  "--chat-content-top-offset": "1.85rem",
  ...
  "--hud-icon": "clamp(2.4rem, 10.6vw, 2.72rem)",
  ...
  "--chat-mobile-back-top": "calc(env(safe-area-inset-top, 0px) + 0.56rem)",
  "--chat-mobile-back-size": "4rem",
  "--chat-mobile-show-size": "3.42rem",
  "--chat-mobile-show-icon-size": "3.14rem",
  "--chat-mobile-rail-size": "clamp(2.76rem, 9.3vw, 3.08rem)",
  "--chat-composer-side-control-size": "2.8rem",
  "--chat-composer-main-control-size": "2.96rem",
  "--chat-composer-send-control-size": "2.76rem",
  "--chat-composer-send-icon-size": "1rem",
  "--chat-composer-plus-icon-size": "2.04rem",
  "--chat-composer-listen-icon-size": "1.76rem",
  "--chat-composer-mic-icon-size": "1.48rem",
  "--chat-send-btn-scale": "0.95",
  "--inputbar-h": "2.96rem",
  "--chat-mobile-hud-center-y": "calc(var(--chat-mobile-back-top) + (var(--chat-mobile-back-size) / 2))",
  "--chat-mobile-show-top": "calc(var(--chat-mobile-hud-center-y) - (var(--chat-mobile-show-size) / 2))",
  "--chat-mobile-rail-top": "calc(var(--chat-mobile-hud-center-y) - (var(--chat-mobile-rail-size) / 2))"
