const CHAT_LAYOUT_BASE_VARS = Object.freeze({
  ...
  "--chat-window-fade-top": "clamp(1.7rem, 3.9vh, 2.45rem)",
  ...
  "--chat-window-scroll-top-fade-start": "0.9rem",
  "--chat-window-scroll-top-fade-mid": "1.95rem",
...
const CHAT_LAYOUT_MOBILE_VARS = Object.freeze({
  ...
  "--chat-window-fade-top": "clamp(0.92rem, 2.4vh, 1.45rem)",
  "--chat-window-top-text-fade-extra": "3.7rem",
  "--chat-window-scroll-top-fade-start": "0.52rem",
  "--chat-window-scroll-top-fade-mid": "1.12rem",
  "--chat-window-scroll-top-fade-end": "1.9rem",
