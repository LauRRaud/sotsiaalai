const CHAT_LAYOUT_BASE_VARS = Object.freeze({
  ...
  "--chat-window-fade-top": "clamp(1.65rem, 4.1vh, 2.85rem)",
  "--chat-window-fade-bottom": "clamp(2.05rem, 5.8vh, 3.55rem)",
  "--chat-window-shift-y": "clamp(0.55rem, 1.7vh, 1.25rem)",
  "--chat-window-main-offset": "0rem",
  "--chat-scroll-down-offset": "-1.05rem",
  "--chat-content-top-offset": "5.2rem",
  "--chat-content-spacer": "7.4rem",
  "--chat-content-bottom-spacer": "0.35rem",
  "--chat-window-scroll-top-fade-start": "0.92rem",
  "--chat-window-scroll-top-fade-mid": "1.92rem",
  "--chat-window-scroll-top-fade-end": "3.25rem",
...
const CHAT_LAYOUT_DESKTOP_FOCUS_OVERRIDES = Object.freeze({
  ...
  "--chat-window-shift-y": "clamp(0.45rem, 1.6vh, 1.15rem)",
  ...
  "--chat-window-top-offset": "clamp(0.12rem, 0.7vh, 0.48rem)",
  "--chat-window-bottom-gap": "-0.45rem",
  ...
  "--chat-window-fade-top-focus": "clamp(1.45rem, 3.6vh, 2.5rem)",
  "--chat-window-scroll-top-fade-start-focus": "0.82rem",
  "--chat-window-scroll-top-fade-mid-focus": "1.68rem",
  "--chat-window-scroll-top-fade-end-focus": "2.85rem",
  "--chat-window-fade-bottom-focus": "clamp(3.2rem, 8.2vh, 5.4rem)",
