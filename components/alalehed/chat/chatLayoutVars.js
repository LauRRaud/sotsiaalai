...
const CHAT_LAYOUT_DESKTOP_FOCUS_OVERRIDES = Object.freeze({
  ...
  "--chat-window-top-safe": "5.7rem",
  "--chat-window-curve-x": "118%",
  "--chat-window-curve-y": "56%",
  "--chat-window-curve-y-left": "calc(var(--chat-window-curve-y) - 1.25%)",
  "--chat-window-curve-y-right": "calc(var(--chat-window-curve-y) + 1.25%)",
  "--chat-window-pad-bottom": "calc(clamp(1.6rem, 3.2dvh, 2.4rem) + 1.1rem)",
  "--chat-window-top-offset": "1.05rem",
  ...
  "--chat-content-top-offset": "6.6rem",
