...
const ConversationView = memo(function ConversationView({
  ...
  const windowClassName =
    ...
    "[--chat-window-fade-bottom-default:clamp(1.2rem,4vh,2rem)] [--chat-window-fade-bottom-focus-default:clamp(1.45rem,4.8vh,2.4rem)] [--chat-window-fade-bottom-focus:var(--chat-window-fade-bottom-focus-default)] [--chat-window-fade-bottom-active:var(--chat-window-fade-bottom,var(--chat-window-fade-bottom-default))] " +
  ...
  const scrollClassName =
    ...
    "[mask-image:linear-gradient(to_bottom,transparent_0%,rgba(0,0,0,0.015)_calc(var(--chat-window-fade-top-active)*0.06+var(--chat-window-scroll-top-fade-start-active)*0.22),rgba(0,0,0,0.045)_calc(var(--chat-window-fade-top-active)*0.16+var(--chat-window-scroll-top-fade-start-active)*0.46),rgba(0,0,0,0.1)_calc(var(--chat-window-fade-top-active)*0.3+var(--chat-window-scroll-top-fade-mid-active)*0.52),rgba(0,0,0,0.2)_calc(var(--chat-window-fade-top-active)*0.48+var(--chat-window-scroll-top-fade-mid-active)*0.76),rgba(0,0,0,0.36)_calc(var(--chat-window-fade-top-active)*0.72+var(--chat-window-scroll-top-fade-end-active)*0.82),rgba(0,0,0,0.58)_calc(var(--chat-window-fade-top-active)*1.02+var(--chat-window-scroll-top-fade-end-active)*0.94),rgba(0,0,0,0.82)_calc(var(--chat-window-fade-top-active)*1.28+var(--chat-window-scroll-top-fade-end-active)),#000_calc(var(--chat-window-fade-top-active)*1.46+var(--chat-window-scroll-top-fade-end-active)*1.04),#000_calc(100%-(var(--chat-window-fade-bottom-active)*1.08)),rgba(0,0,0,0.84)_calc(100%-(var(--chat-window-fade-bottom-active)*0.66)),rgba(0,0,0,0.44)_calc(100%-(var(--chat-window-fade-bottom-active)*0.3)),rgba(0,0,0,0.12)_calc(100%-(var(--chat-window-fade-bottom-active)*0.1)),transparent_100%)] " +
    "[-webkit-mask-image:linear-gradient(to_bottom,transparent_0%,rgba(0,0,0,0.015)_calc(var(--chat-window-fade-top-active)*0.06+var(--chat-window-scroll-top-fade-start-active)*0.22),rgba(0,0,0,0.045)_calc(var(--chat-window-fade-top-active)*0.16+var(--chat-window-scroll-top-fade-start-active)*0.46),rgba(0,0,0,0.1)_calc(var(--chat-window-fade-top-active)*0.3+var(--chat-window-scroll-top-fade-mid-active)*0.52),rgba(0,0,0,0.2)_calc(var(--chat-window-fade-top-active)*0.48+var(--chat-window-scroll-top-fade-mid-active)*0.76),rgba(0,0,0,0.36)_calc(var(--chat-window-fade-top-active)*0.72+var(--chat-window-scroll-top-fade-end-active)*0.82),rgba(0,0,0,0.58)_calc(var(--chat-window-fade-top-active)*1.02+var(--chat-window-scroll-top-fade-end-active)*0.94),rgba(0,0,0,0.82)_calc(var(--chat-window-fade-top-active)*1.28+var(--chat-window-scroll-top-fade-end-active)),#000_calc(var(--chat-window-fade-top-active)*1.46+var(--chat-window-scroll-top-fade-end-active)*1.04),#000_calc(100%-(var(--chat-window-fade-bottom-active)*1.08)),rgba(0,0,0,0.84)_calc(100%-(var(--chat-window-fade-bottom-active)*0.66)),rgba(0,0,0,0.44)_calc(100%-(var(--chat-window-fade-bottom-active)*0.3)),rgba(0,0,0,0.12)_calc(100%-(var(--chat-window-fade-bottom-active)*0.1)),transparent_100%)] " +
    "max-[768px]:[mask-image:linear-gradient(to_bottom,transparent_0%,rgba(0,0,0,0.02)_calc(var(--chat-window-fade-top-active)*0.22+var(--chat-window-scroll-top-fade-start-active)*0.4),rgba(0,0,0,0.08)_calc(var(--chat-window-fade-top-active)*0.52+var(--chat-window-scroll-top-fade-mid-active)*0.58),rgba(0,0,0,0.18)_calc(var(--chat-window-fade-top-active)*0.86+var(--chat-window-scroll-top-fade-end-active)*0.72),rgba(0,0,0,0.38)_calc(var(--chat-window-fade-top-active)*1.18+var(--chat-window-scroll-top-fade-end-active)*0.9),rgba(0,0,0,0.68)_calc(var(--chat-window-fade-top-active)*1.48+var(--chat-window-scroll-top-fade-end-active)*1.02),#000_calc(var(--chat-window-fade-top-active)*1.7+var(--chat-window-scroll-top-fade-end-active)*1.08),#000_calc(100%-(var(--chat-window-fade-bottom-active)*1.02)),rgba(0,0,0,0.82)_calc(100%-(var(--chat-window-fade-bottom-active)*0.72)),rgba(0,0,0,0.52)_calc(100%-(var(--chat-window-fade-bottom-active)*0.42)),rgba(0,0,0,0.18)_calc(100%-(var(--chat-window-fade-bottom-active)*0.16)),transparent_100%)] " +
