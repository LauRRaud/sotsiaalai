...
const ConversationView = memo(function ConversationView({
  ...
  const scrollClassName =
    ...
    "[mask-image:linear-gradient(to_bottom,transparent_0%,rgba(0,0,0,0.04)_calc(var(--chat-window-fade-top-active)*0.12+var(--chat-window-scroll-top-fade-start-active)),rgba(0,0,0,0.12)_calc(var(--chat-window-fade-top-active)*0.3+var(--chat-window-scroll-top-fade-mid-active)),rgba(0,0,0,0.34)_calc(var(--chat-window-fade-top-active)*0.58+var(--chat-window-scroll-top-fade-end-active)),rgba(0,0,0,0.72)_calc(var(--chat-window-fade-top-active)*0.92+var(--chat-window-scroll-top-fade-end-active)),#000_calc(var(--chat-window-fade-top-active)*1.34+var(--chat-window-scroll-top-fade-end-active)),#000_calc(100%-(var(--chat-window-fade-bottom-active)*1.08)),rgba(0,0,0,0.84)_calc(100%-(var(--chat-window-fade-bottom-active)*0.66)),rgba(0,0,0,0.44)_calc(100%-(var(--chat-window-fade-bottom-active)*0.3)),rgba(0,0,0,0.12)_calc(100%-(var(--chat-window-fade-bottom-active)*0.1)),transparent_100%)] " +
