...
const ConversationView = memo(function ConversationView({
  ...
  const scrollClassName =
    ...
    "[mask-image:linear-gradient(to_bottom,transparent_0%,rgba(0,0,0,0.02)_calc(var(--chat-window-fade-top-active)*0.08+var(--chat-window-scroll-top-fade-start-active)*0.24),rgba(0,0,0,0.08)_calc(var(--chat-window-fade-top-active)*0.24+var(--chat-window-scroll-top-fade-mid-active)*0.42),rgba(0,0,0,0.18)_calc(var(--chat-window-fade-top-active)*0.44+var(--chat-window-scroll-top-fade-end-active)*0.58),rgba(0,0,0,0.38)_calc(var(--chat-window-fade-top-active)*0.7+var(--chat-window-scroll-top-fade-end-active)*0.76),rgba(0,0,0,0.7)_calc(var(--chat-window-fade-top-active)*0.98+var(--chat-window-scroll-top-fade-end-active)*0.96),#000_calc(var(--chat-window-fade-top-active)*1.22+var(--chat-window-scroll-top-fade-end-active)*1.04),#000_calc(100%-(var(--chat-window-fade-bottom-active)*1.08)),rgba(0,0,0,0.84)_calc(100%-(var(--chat-window-fade-bottom-active)*0.66)),rgba(0,0,0,0.44)_calc(100%-(var(--chat-window-fade-bottom-active)*0.3)),rgba(0,0,0,0.12)_calc(100%-(var(--chat-window-fade-bottom-active)*0.1)),transparent_100%)] " +
