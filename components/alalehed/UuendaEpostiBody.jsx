        ...
        <div className={contentClassName}>
          {submitted ? <div className="flex flex-col gap-4 text-center">
              ...
              <div className="mt-[clamp(1.8rem,4.6vh,3rem)] flex justify-center">
                <button type="submit" className={`${buttonBaseClassName} ${buttonPrimaryClassName} px-[1.6rem] py-[1.05rem] text-[1.18rem]`.trim()} disabled={loading} aria-disabled={loading ? "true" : undefined}>
                  <span>
