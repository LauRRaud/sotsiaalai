...
export default function MeistBody({
  ...
  const introParagraphs = [{
    key: "p1",
    value: t("about.intro.paragraph1")
  }, {
    key: "p2",
    value: t("about.intro.paragraph2")
  }, {
    key: "p3",
    ...
    key: "p4",
    value: t("about.intro.paragraph4")
  }, {
    key: "p5",
    value: t("about.intro.paragraph5")
  }];
  if (embedded) {
    const embeddedParagraphs = introParagraphs.filter(({
      key
    }) => key !== "p4" && key !== "p5").map(paragraph => {
    ...
    const paragraph3 = embeddedParagraphs.find(({
      key
    }) => key === "p3");
    return <div className="home-about-content" role="region" aria-labelledby="home-about-title" lang={locale}>
        <h2 id="home-about-title" className="home-section-title text-center text-[clamp(1.9rem,3.9vw,2.6rem)] font-[var(--font-aino-headline),var(--font-aino),Arial,sans-serif] font-medium tracking-[0.02em] mt-0 mb-[1.1rem] [color:var(--pt-100,#ecebe9)]">
          {t("about.title")}
        </h2>
  ...
  return <div className="main-content glass-box glass-left meist-body" role="region" aria-labelledby="meist-title" lang={locale}>
