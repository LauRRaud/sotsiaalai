...
export default function PrivaatsusBody() {
  ...
  return <section className={pageShellClassName} lang={locale}>
      <div className="relative flex flex-col items-center">
        ...
        />
        <h1 id="privacy-title" className={cn(titleClassName, glassPolicyTitleOffsetClassName, isExpandedLayout ? glassPolicyTitleExpandedClassName : null)}>
          {t("privacy.title")}
        </h1>
        <div className={cn(contentClassName, "glass-ring-content", "policy-page-content", "privacy-page-content", isExpandedLayout ? "glass-ring-content--open" : null, isExpandedLayout ? glassPolicyContentExpandedClassName : null)}>
          <div
          ...
          >
            ...
            <footer className={cn(
              ...
              isExpandedLayout
                ...
                : "mt-[clamp(1.5rem,3.4vh,2.4rem)] mb-[clamp(0.35rem,1vh,0.7rem)] max-[768px]:mt-[clamp(1.2rem,3vh,1.9rem)] max-[768px]:mb-[clamp(0.28rem,0.9vh,0.62rem)]"
            )}>
              {getFooterNote()}
            </footer>
          </div>
