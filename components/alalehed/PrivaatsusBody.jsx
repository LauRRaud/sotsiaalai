    ...
    <div className="alaleht-hero">
      <div className="alaleht-inner">
        <div className="alaleht-box">
          <h1 className="alaleht-title">Privaatsustingimused</h1>

          <section className="alaleht-section">
            <p>
              <span className="alaleht-h2-number">1.</span>{" "}
              <span className="alaleht-h2-span">Üldsätted</span>
            </p>
            ...
            <p>
              <span className="alaleht-h2-number">2.</span>{" "}
              <span className="alaleht-h2-span">Kogutavad andmed</span>
            </p>
            ...
            <p>
              <span className="alaleht-h2-number">3.</span>{" "}
              <span className="alaleht-h2-span">Andmete kasutamine</span>
            </p>
            ...
            <p>
              <span className="alaleht-h2-number">4.</span>{" "}
              <span className="alaleht-h2-span">Vestluste privaatsus</span>
            </p>
            <p>4.1 Vestluste sisu ei salvestata, logita ega kasutata turunduse või analüütika eesmärgil.</p>

            <p>
              <span className="alaleht-h2-number">5.</span>{" "}
              <span className="alaleht-h2-span">Tehisintellekti teenused</span>
            </p>
            <p>5.1 Kasutame kolmanda osapoole teenuseid (nt OpenAI), mis võivad töödelda teksti serverites väljaspool EL-i.</p>

            <p>
              <span className="alaleht-h2-number">6.</span>{" "}
              <span className="alaleht-h2-span">Andmete jagamine</span>
            </p>
            ...
            <p>
              <span className="alaleht-h2-number">7.</span>{" "}
              <span className="alaleht-h2-span">Andmete säilitamine</span>
            </p>
            <p>7.1 Andmeid säilitatakse kuni konto kustutamiseni või seaduses sätestatud perioodi lõpuni.</p>

            <p>
              <span className="alaleht-h2-number">8.</span>{" "}
              <span className="alaleht-h2-span">Kasutaja õigused</span>
            </p>
            ...
            <p>
              <span className="alaleht-h2-number">9.</span>{" "}
              <span className="alaleht-h2-span">Küpsised</span>
            </p>
            <p>9.1 Kasutame ainult vajalikke küpsiseid (nt sisselogimiseks või sessioonihalduseks).</p>

            <p>
              <span className="alaleht-h2-number">10.</span>{" "}
              <span className="alaleht-h2-span">Turvalisus</span>
            </p>
            <p>10.1 Kasutame asjakohaseid tehnilisi ja organisatsioonilisi meetmeid andmete kaitsmiseks.</p>

            <p>
              <span className="alaleht-h2-number">11.</span>{" "}
              <span className="alaleht-h2-span">Tingimuste muudatused</span>
            </p>
