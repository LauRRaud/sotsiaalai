...
const lawLinkReplacements = {
  aLawEst: {
    open: '<a href="https://www.riigiteataja.ee/akt/112072025014" target="_blank" rel="noopener noreferrer" class="link-brand">',
    close: "</a>"
  },
  aGdpr: {
    open: '<a href="https://eur-lex.europa.eu/legal-content/ET/TXT/HTML/?uri=CELEX:02016R0679-20160504" target="_blank" rel="noopener noreferrer" class="link-brand">',
    close: "</a>"
  },
  aDpa: {
    open: '<a href="https://www.aki.ee" target="_blank" rel="noopener noreferrer" class="link-brand">',
    close: "</a>"
  }
};
export default function PrivaatsusBody() {
  ...
  return <section className={pageShellClassName} lang={locale}>
      <div className={circleClassName} role="region" aria-labelledby="privacy-title">
        ...
        <h1 id="privacy-title" className={`glass-title ${titleClassName}`}>
          {t("privacy.title")}
        </h1>
