...
const profileMobileActionStackClassName =
  "profile-mobile-action-stack absolute inset-x-0 bottom-[calc(env(safe-area-inset-bottom,0px)+5.9rem)] z-[95] flex w-full flex-col items-center justify-center " +
