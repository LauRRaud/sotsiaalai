...
const surfaceClassName =
  ...
  `min-[769px]:[--workspace-subpage-header-margin-bottom:0.35rem] min-[769px]:[--workspace-subpage-title-margin-top:clamp(2.15rem,5.4vh,3.25rem)] min-[769px]:[--workspace-subpage-title-margin-bottom:clamp(0.35rem,1.4vh,0.8rem)] px-[1.1rem] pt-[0.35rem] pb-[1.15rem] max-[768px]:mx-[max(var(--mobile-glass-card-gap,0.35rem),env(safe-area-inset-left,0px))] max-[768px]:w-[calc(100vw-env(safe-area-inset-left,0px)-env(safe-area-inset-right,0px)-(var(--mobile-glass-card-gap,0.35rem)*2))] ` +
