...
export const buttonPrimaryClassName =
  "border border-[color:color-mix(in_srgb,var(--admin-accent)_65%,var(--admin-border)_35%)] bg-[color-mix(in_srgb,var(--admin-accent)_14%,var(--admin-surface)_86%)] text-[color:var(--admin-text)] hover:border-[color:var(--admin-accent)] hover:shadow-[0_0_0_2px_var(--admin-accent-soft)]";
export const buttonGhostClassName =
  "border border-[color:var(--admin-border-strong)] bg-transparent text-[color:var(--admin-text)] shadow-none hover:bg-[color-mix(in_srgb,var(--admin-surface-2)_70%,transparent)]";
...
export const buttonSecondaryClassName =
  "border border-[color:var(--admin-border-strong)] bg-[color:var(--admin-surface-2)] text-[color:var(--admin-text)] shadow-none";
