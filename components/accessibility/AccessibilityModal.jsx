...
const titleClassName =
  `${glassPageTitleClassName} glass-title-register !text-[clamp(1.58rem,calc(var(--ring-diameter,52rem)/24.5),2.12rem)] min-[48.0625em]:!mt-0 min-[48.0625em]:!mb-0 max-[48em]:!text-[clamp(2rem,7.9vw,2.75rem)] max-[48em]:!leading-[1.06] max-[48em]:!mt-0 max-[48em]:!mb-0 max-[48em]:!px-0 max-[48em]:!whitespace-normal`;
...
export default function AccessibilityModal({
  ...
  return <>
      ...
      <div ref={boxRef} className={`${modalRootClassName} ${modalRootMobileClassName} ${modalRootDesktopClassName} scroll-reactive-shell [--csp-chevron-top:clamp(0.12rem,0.55vh,0.45rem)] [--csp-chevron-bottom:clamp(0.12rem,0.55vh,0.45rem)] [--csp-arrow-size:clamp(2.55rem,calc(var(--ring-diameter,52rem)/16.8),3.25rem)] max-[48em]:[--csp-arrow-size:clamp(2.25rem,9.8vw,2.95rem)] max-[48em]:[--csp-chevron-top:clamp(0.22rem,1.15vw,0.52rem)] max-[48em]:[--csp-chevron-bottom:clamp(0.22rem,1.1vw,0.5rem)]`.trim()} data-scrolled={hasUserStartedScroll && isScrolled ? "1" : "0"} role="dialog" aria-modal="true" aria-labelledby="a11y-title" onClick={stopInside} tabIndex={-1}>
        {}
