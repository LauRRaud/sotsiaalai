...
export default function LoginModal({
  ...
  const pinKeyBackground = isLightTheme
    ? isMidTheme
      ...
      : "radial-gradient(122% 122% at 26% 22%, rgba(255, 255, 255, 0.66) 0%, rgba(255, 255, 255, 0.26) 26%, rgba(255, 255, 255, 0.08) 46%, rgba(255, 255, 255, 0) 60%), radial-gradient(102% 102% at 76% 80%, rgba(164, 112, 104, 0.055) 0%, rgba(164, 112, 104, 0.018) 34%, rgba(164, 112, 104, 0) 62%), linear-gradient(155deg, rgba(255, 255, 255, 0.34) 0%, rgba(255, 255, 255, 0.2) 42%, rgba(255, 255, 255, 0.12) 100%), rgba(255, 255, 255, 0.17)"
    : isNightTheme
  ...
  const pinGlossBackground = isLightTheme
    ? isMidTheme
      ...
      : "linear-gradient(138deg, rgba(255, 255, 255, 0.26) 0%, rgba(255, 255, 255, 0.11) 22%, rgba(255, 255, 255, 0.025) 44%, rgba(255, 255, 255, 0) 66%, rgba(122, 58, 56, 0.028) 100%), radial-gradient(64% 58% at 32% 24%, rgba(255, 255, 255, 0.14) 0%, rgba(255, 255, 255, 0.045) 36%, rgba(255, 255, 255, 0) 72%)"
