...
export default function LoginModal({
  ...
  const pinKeyBoxShadow = isLightTheme
    ...
    : isNightTheme
      ? "0 4px 9px rgba(2, 6, 16, 0.13), 0 1px 1px rgba(15, 23, 42, 0.065), 0 0 11px rgba(214, 231, 255, 0.17), 0 8px 12px -6px rgba(120, 168, 230, 0.22), 0 16px 20px -16px rgba(208, 228, 255, 0.3), inset 0 0 0 var(--pin-border-w) rgba(30, 40, 58, 0.52), inset 0 1px 0 rgba(255, 255, 255, 0.04), inset 0 -1px 0 rgba(2, 6, 16, 0.19)"
      : "0 4px 9px rgba(0, 0, 0, 0.12), 0 1px 1px rgba(15, 23, 42, 0.065), 0 0 10px rgba(248, 253, 255, 0.14), 0 8px 12px -6px rgba(248, 253, 255, 0.16), 0 16px 20px -16px rgba(248, 253, 255, 0.24), inset 0 0 0 var(--pin-border-w) rgba(34, 42, 56, 0.48), inset 0 1px 0 rgba(255, 255, 255, 0.035), inset 0 -1px 0 rgba(0, 0, 0, 0.18)";
