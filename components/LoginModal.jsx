...
export default function LoginModal({
  ...
  const pinKeyBackground = isLightTheme
    ? isMidTheme
      ...
      : "radial-gradient(122% 122% at 26% 22%, rgba(255, 255, 255, 0.5) 0%, rgba(255, 255, 255, 0.18) 26%, rgba(255, 255, 255, 0.05) 46%, rgba(255, 255, 255, 0) 60%), radial-gradient(102% 102% at 76% 80%, rgba(164, 112, 104, 0.06) 0%, rgba(164, 112, 104, 0.02) 34%, rgba(164, 112, 104, 0) 62%), linear-gradient(155deg, rgba(255, 255, 255, 0.26) 0%, rgba(255, 255, 255, 0.14) 42%, rgba(255, 255, 255, 0.08) 100%), rgba(255, 255, 255, 0.12)"
    : isNightTheme
  ...
  const pinKeyBoxShadow = isLightTheme
    ? isMidTheme
      ...
      : "0 10px 18px rgba(0, 0, 0, 0.08), inset 0 0 0 var(--pin-border-w) rgba(255, 255, 255, 0.14), inset 0 1px 0 rgba(255, 255, 255, 0.56), inset 0 -1px 0 rgba(0, 0, 0, 0.09)"
  ...
  const pinGlossBackground = isLightTheme
    ? isMidTheme
      ...
      : "linear-gradient(138deg, rgba(255, 255, 255, 0.18) 0%, rgba(255, 255, 255, 0.07) 22%, rgba(255, 255, 255, 0.015) 44%, rgba(255, 255, 255, 0) 66%, rgba(122, 58, 56, 0.03) 100%), radial-gradient(64% 58% at 32% 24%, rgba(255, 255, 255, 0.1) 0%, rgba(255, 255, 255, 0.03) 36%, rgba(255, 255, 255, 0) 72%)"
  ...
  const pinGlossOpacityBase = isLightTheme ? isMidTheme ? "0.14" : "0.08" : "0.2";
  const pinGlossOpacityButton = isLightTheme ? isMidTheme ? "0.1" : "0.06" : isNightTheme ? "0.28" : "0.24";
