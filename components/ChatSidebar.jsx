...
export default function ChatSidebar() {
  ...
  const messageCardClassNameCommon =
    ...
    "bg-[rgba(20,20,24,0.38)] [.theme-night_&]:bg-[rgba(10,14,24,0.32)] p-[0.75rem_0.85rem] max-[48em]:p-[0.9rem_0.95rem] text-[color:var(--pt-120)] " +
    "shadow-[0_0.4rem_1rem_rgba(0,0,0,0.25)] transition-[transform,border-color,background,box-shadow] duration-150 " +
    "hover:-translate-y-[1px] hover:border-[rgba(148,163,184,0.35)] hover:bg-[rgba(28,28,34,0.44)] [.theme-night_&:hover]:bg-[rgba(16,22,34,0.4)] hover:shadow-[0_0.55rem_1.35rem_rgba(0,0,0,0.32)] " +
    "focus-within:-translate-y-[1px] focus-within:border-[rgba(148,163,184,0.35)] focus-within:bg-[rgba(28,28,34,0.44)] [.theme-night_&:focus-within]:bg-[rgba(16,22,34,0.4)] focus-within:shadow-[0_0.55rem_1.35rem_rgba(0,0,0,0.32)] " +
  ...
  const messageActiveVariant =
    "drawer-chat-card--active border-[rgba(148,163,184,0.42)] bg-[rgba(30,30,36,0.52)] [.theme-night_&]:bg-[rgba(18,24,36,0.48)] shadow-[0_0.6rem_1.45rem_rgba(0,0,0,0.36)] [.theme-light_&]:border-[rgba(148,163,184,0.62)] [.theme-light_&]:bg-[rgba(255,255,255,0.98)]";
