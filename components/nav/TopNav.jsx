...
export default function TopNav({
  ...
  const openChatsDrawer = useCallback(e => {
  ...
  return <nav className={`top-nav${isChatLike ? " top-nav--chat" : ""}${className ? ` ${className}` : ""}`} style={style}>
      {!hideChats && <button type="button" className={`top-nav__btn${pathname.startsWith("/vestlus") ? " top-nav__btn--active" : ""}${railItemClass}`} onClick={openChatsDrawer} aria-label={t("nav.chats", "Vestlused")} {...railItemAttrs}>
