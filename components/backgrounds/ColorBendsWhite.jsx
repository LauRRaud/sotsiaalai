...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    renderer.setClearColor(0x0b0d12, transparent ? 0 : 1);
  ...
  useEffect(() => {
    ...
    if (renderer) renderer.setClearColor(0xffffff, transparent ? 0 : 1);
  ...
  return <div ref={containerRef} className={`color-bends-container color-bends-light ${className || ''}`} style={style} />;
}
