...
const contentStyles = "w-full max-w-[32rem] rounded-[var(--subpage-card-radius,1.2rem)] border border-solid border-[color:var(--rail-tooltip-border,var(--subpage-card-border))] [background:var(--rail-tooltip-bg,var(--subpage-card-bg))] p-[1.6rem] text-[color:var(--rail-tooltip-text,var(--subpage-card-text,var(--pt-50)))] shadow-[var(--rail-tooltip-shadow,var(--subpage-card-shadow))] backdrop-blur-[16px] backdrop-saturate-[140%] hc:text-[color:var(--hc-text)] hc:border-[color:var(--hc-accent)] hc:bg-[color:var(--hc-bg)]";
