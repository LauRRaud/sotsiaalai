export const primarySegmentedButtonClassName =
  ...
  "hc:[--seg-card-bg-hover:var(--btn-primary-bg-hover)] hc:[--seg-card-bg-selected:var(--btn-primary-bg-hover)] hc:[--seg-card-bg-active:var(--btn-primary-bg-active,var(--seg-card-bg-selected))] " +
  "hc:[--seg-card-border-width:2px] hc:[--seg-card-border:rgba(255,234,0,0.66)] hc:[--seg-card-border-hover:rgba(255,234,0,0.9)] hc:[--seg-card-border-selected:rgba(255,234,0,0.94)] hc:[--seg-card-border-active:rgba(255,234,0,0.95)] " +
  "!duration-[560ms] !ease-[cubic-bezier(0.22,0.61,0.36,1)]";
