...
const baseStyles = "rounded-[1.1rem] [border-width:var(--panel-border-width,var(--glass-border-width,1px))] border-solid";
const variantStyles = {
  ...
  secondary: "rounded-[var(--panel-secondary-radius)] [border-width:var(--panel-secondary-border-width,var(--panel-border-width,var(--glass-border-width,1px)))] border-[color:var(--panel-secondary-border)] bg-[color:var(--panel-secondary-bg)] text-[color:var(--glass-modal-text)] shadow-[var(--panel-secondary-shadow)]",
  subpage: "rounded-[var(--subpage-card-radius)] [border-width:var(--subpage-card-border-width,var(--panel-border-width,var(--glass-border-width,1px)))] border-[color:var(--subpage-card-border)] [background:var(--subpage-card-bg)] text-[color:var(--subpage-card-text,var(--glass-modal-text,var(--glass-surface-text,#f2f2f2)))] shadow-[var(--subpage-card-shadow)]"
};
const paddingStyles = {
  sm: "p-[1rem]",
  md: "p-[1.5rem]",
