export const glassPageTitleClassName =
  "mt-[clamp(2.15rem,5.4vh,3.25rem)] mb-[clamp(0.35rem,1.4vh,0.8rem)] text-center text-[2.15em] max-[48em]:text-[clamp(2rem,8.4vw,2.8rem)] leading-[1.15] tracking-[0.03em] " +
  "w-full max-w-full [overflow-wrap:anywhere] [word-break:break-word] [text-wrap:balance] max-[48em]:px-[clamp(1rem,5.2vw,2rem)] " +
...
export const glassPageBackMobileBottomCenterClassName =
  `${glassPageBackClassName} ` +
  "max-[48em]:!inline-flex max-[48em]:top-[calc(env(safe-area-inset-top,0px)+0.42rem)] max-[48em]:left-[calc(env(safe-area-inset-left,0px)+0.42rem)] " +
  "max-[48em]:translate-x-0 max-[48em]:translate-y-0 max-[48em]:bottom-auto " +
  "max-[48em]:h-[3.65rem] max-[48em]:w-[3.65rem] max-[48em]:z-[92] " +
  "max-[48em]:[&>span]:h-[3.65rem] max-[48em]:[&>span]:w-[3.65rem]";
