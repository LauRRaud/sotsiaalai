export const glassPageTitleClassName =
  "mt-[clamp(2.15rem,5.4vh,3.25rem)] mb-[clamp(0.35rem,1.4vh,0.8rem)] text-center text-[2.15em] max-[768px]:text-[clamp(1.72rem,6.8vw,2.18rem)] leading-[1.12] tracking-[0.03em] " +
  "w-full max-w-full max-[768px]:mx-auto max-[768px]:whitespace-normal max-[768px]:[text-wrap:balance] max-[768px]:px-[clamp(4rem,15vw,5rem)] max-[768px]:tracking-[0.01em] max-[768px]:mt-[calc(env(safe-area-inset-top,0px)+4.05rem)] max-[768px]:mb-[clamp(0.2rem,0.9vh,0.55rem)] " +
...
export const glassPageTitleMobileHeaderClassName =
  ...
  "max-[768px]:!px-[clamp(4rem,15vw,5rem)] max-[768px]:!whitespace-normal max-[768px]:!leading-[1.04] " +
