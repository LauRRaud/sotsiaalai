...
const primaryStyles = "[border:var(--btn-primary-border)] text-[color:var(--btn-primary-text,rgba(248,252,255,0.92))] [background:var(--btn-primary-bg)] shadow-[var(--btn-primary-shadow)] hover:[background:var(--btn-primary-bg-hover)] hover:shadow-[var(--btn-primary-shadow-hover)] focus-visible:[background:var(--btn-primary-bg-hover)] focus-visible:shadow-[var(--btn-primary-shadow-focus)] active:[border:var(--btn-primary-border-active,var(--btn-primary-border))] active:[background:var(--btn-primary-bg-active)] active:shadow-[var(--btn-primary-shadow-active)]";
