...
const ghostStyles =
  ...
  "[@media(hover:hover)]:hover:bg-[rgba(255,255,255,0.08)] [@media(hover:hover)]:hover:border-[rgba(170,190,215,0.38)] " +
...
const dangerStyles =
  ...
  "[@media(hover:hover)]:hover:before:opacity-100 [@media(hover:hover)]:hover:border-[rgba(255,214,214,0.38)] [@media(hover:hover)]:hover:shadow-[var(--btn-danger-shadow-hover,0_12px_28px_rgba(0,0,0,0.25),inset_0_1px_0_rgba(255,255,255,0.08))] " +
  ...
  "light:[@media(hover:hover)]:hover:border-[rgba(154,43,43,0.32)] light:[@media(hover:hover)]:hover:shadow-[var(--btn-danger-shadow-hover-light,0_10px_22px_rgba(95,28,28,0.18),inset_0_1px_0_rgba(255,255,255,0.14))] " +
