...
const dangerStyles =
  ...
  "[@media(hover:hover)]:hover:bg-[rgba(165,32,32,0.84)] [@media(hover:hover)]:hover:border-[rgba(255,201,201,0.42)] " +
  ...
  "light:[@media(hover:hover)]:hover:bg-[rgba(197,53,53,0.96)] light:[@media(hover:hover)]:hover:border-[rgba(138,28,28,0.36)] " +
