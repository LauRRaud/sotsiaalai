  ...
  return (
    ...
    >
      <div
        role="dialog"
        aria-modal="true"
        className={cn(panelStyles, sideStyles[side] ?? sideStyles.right, panelClassName)}
        {...props}
      >
        {children}
      </div>
