...
export default function BorderGlow({
  ...
  useEffect(() => {
    ...
    const angleEnd = 465;
    const durationScale = Math.max(Number(animationDurationScale) || 1, 0.1);
    ...
    cleanups.push(
      animateValue({
        ease: easeOutCubic,
        delay: 1500 * durationScale,
        duration: 2250 * durationScale,
        start: 50,
        end: 100,
        onUpdate: value => {
          card.style.setProperty(
  ...
  }, [animated, animationDurationScale]);
