# /admin/rag/documents — primitive CSS report

## light

### `.button[data-variant="ghost"]` ×1
...
- **<button>** [visible, disabled] semantic: `button shadow-none`
  ...
  - hover Δ: backgroundColor=color(srgb 0.899346 0.852348 0.84… · color=rgb(34, 34, 34) · borderTopColor=color(srgb 0.57724 0.427975 0.440… · outlineColor=rgb(34, 34, 34)
  - dead@state: `button shadow-none`
  - focus-visible:
    - _0blu2ae._.css | :where(a, button, input, select, textarea, [role], [tab… → [outline-color]

### `.documents-dropdown-trigger` ×6
...
- **<button>** [visible, disabled] semantic: `button shadow-none`
  ...
  - hover Δ: backgroundColor=color(srgb 0.861072 0.789835 0.76… · color=rgb(44, 51, 64) · borderTopColor=color(srgb 0.573183 0.384279 0.38… · outlineColor=rgb(44, 51, 64)
  - dead@state: `button shadow-none`
  - focus-visible:
    - _0blu2ae._.css | :where(a, button, input, select, textarea, [role], [tab… → [outline-color]
...
- **<button>** [visible, disabled] semantic: `button shadow-none`
  ...
  - hover Δ: backgroundColor=color(srgb 0.285299 0.184868 0.19… · color=rgb(242, 242, 242) · borderTopColor=color(srgb 0.815132 0.547391 0.54… · outlineColor=rgb(242, 242, 242)
  - dead@state: `button shadow-none`
  - focus-visible:
    - _0blu2ae._.css | :where(a, button, input, select, textarea, [role], [tab… → [outline-color]
...
- **<button>** [visible, disabled] semantic: `button shadow-none`
  ...
  - tokens: --btn-primary-bg=radial-gradient(82% 66% at 50% -1… · --btn-primary-bg-hover=radial-gradient(82% 66% at 50% -1… · --btn-primary-text=#f8fcfff5 · --btn-primary-shadow=inset 0 1px 0 #dcecff1a,
    0 5p… · --btn-primary-border=0 solid transparent
  - hover Δ: backgroundColor=color(srgb 0.303755 0.225174 0.25… · color=rgb(230, 229, 227) · borderTopColor=color(srgb 0.75526 0.530518 0.569… · outlineColor=rgb(230, 229, 227)
  - dead@state: `button shadow-none`
  - focus-visible:
    - _0blu2ae._.css | :where(a, button, input, select, textarea, [role], [tab… → [outline-color]
...
- **<button>** [visible, disabled] semantic: `button shadow-none`
  ...
  - tokens: --btn-primary-bg=radial-gradient(118% 102% at 50% … · --btn-primary-bg-hover=radial-gradient(118% 102% at 50% … · --btn-primary-text=#e6e6e6f5 · --btn-primary-shadow=inset 0 1px 0 #d6d6d614,
    0 5p… · --btn-primary-border=0 solid transparent
  - hover Δ: backgroundColor=color(srgb 0.261953 0.186329 0.18… · color=oklab(0.845137 0.0000384913 0.000… · borderTopColor=oklab(0.653655 0.0710001 0.025407… · outlineColor=oklab(0.845137 0.0000384913 0.000…
  - dead@state: `button shadow-none`
  - resting:
...
- **<button>** [visible, disabled] semantic: `button shadow-none`
  ...
  - hover Δ: backgroundColor=color(srgb 0.273666 0.26808 0.070… · color=rgb(255, 234, 0) · borderTopColor=color(srgb 1 0.917647 0 / 0.69121… · outlineColor=rgb(255, 234, 0)
  - dead@state: `button shadow-none`
  - resting:
