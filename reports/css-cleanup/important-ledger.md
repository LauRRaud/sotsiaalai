...
| `theme/mono.css` | 148 | 0 | 0 | oraakel STRIP 0: repair-loop jääb kinni mitme-markeri-oraaklitel (greedy üksik-restore ei vähenda → safety keep-all). TÖÖRIISTA-piirang, mitte päris-lukk. Järgmine võit kui repair = batch-restore | 148 | ⬜ | — |
