...
Crawled 37 routes × 6 themes × 4 viewports against http://localhost:3000.
Universe: 3530 rule-selectors. States pass: on.
...
## Dead — element never renders — 1232
...
-   `app\styles\theme\dark.css:362` — `:root:not(.theme-light):not(.theme-mid)
  ...
  .box`
-   `app\styles\theme\hc.css:27` — `html[data-reduce-motion="1"] .glass-card.fade-in`
-   `app\styles\theme\hc.css:46` — `.three-d-card:has(.glass-card.fade-in)`
-   `app\styles\theme\hc.css:46` — `.three-d-card:has(.centered-back-left.fade-in)`
-   `app\styles\theme\hc.css:46` — `.three-d-card:has(.centered-back-right.fade-in)`
-   `app\styles\theme\hc.css:313` — `html[data-ui-scale="mac"][data-contrast="hc"]`
-   `app\styles\theme\hc.css:313` — `html[data-ui-scale="lg"][data-contrast="hc"]`
-   `app\styles\theme\hc.css:359` — `html[data-contrast="hc"] :is(.register-success-shell, .error-page-shell)`
-   `app\styles\theme\hc.css:366` — `html[data-contrast="hc"] .register-success-shell .register-success-panel`
-   `app\styles\theme\hc.css:370` — `html[data-contrast="hc"] .register-success-shell .register-success-panel`
-   `app\styles\theme\hc.css:370` — `html[data-contrast="hc"] .register-success-shell .register-success-panel *`
-   `app\styles\theme\hc.css:379` — `html[data-contrast="hc"] .homepage-root .home-before-contact-copy`
-   `app\styles\theme\hc.css:379` — `html[data-contrast="hc"] .homepage-root .home-before-contact-copy *`
-   `app\styles\theme\hc.css:421` — `html[data-contrast="hc"] .back-icon-dot.back-icon-dot--outline`
-   `app\styles\theme\hc.css:426` — `html[data-contrast="hc"] button:is(:hover, :focus-visible) .back-icon-dot.back-icon-dot--outline`
-   `app\styles\theme\hc.css:430` — `html[data-contrast="hc"] .error-page-shell .error-page-description`
-   `app\styles\theme\hc.css:575` — `html[data-contrast="hc"] .invite-modal-overlay.person-invite-modal-overlay`
-   `app\styles\theme\hc.css:580` — `html[data-contrast="hc"] body.invite-modal-open .chat-page-shell`
-   `app\styles\theme\hc.css:625` — `html[data-contrast="hc"] :is(
  .invite-list-row,
  .help-listings-item-card
)`
-   `app\styles\theme\hc.css:631` — `html[data-contrast="hc"] body .chat-analysis-overlay .chat-analysis-overlay-card :is(.button, .btn)`
-   `app\styles\theme\hc.css:637` — `html[data-contrast="hc"] body .chat-analysis-overlay .documents-upload-choose-button`
-   `app\styles\theme\hc.css:646` — `html[data-contrast="hc"] body .chat-analysis-overlay .chat-analysis-overlay-card :is(.button, .btn):is(:hover, :focus-visible)`
-   `app\styles\theme\hc.css:651` — `html[data-contrast="hc"] body .chat-analysis-overlay .documents-upload-choose-button:is(:hover, :focus-visible)`
-   `app\styles\theme\hc.css:656` — `html[data-contrast="hc"] body .chat-analysis-overlay .chat-analysis-overlay-card :is(.button, .btn):active`
-   `app\styles\theme\hc.css:661` — `html[data-contrast="hc"] body .chat-analysis-overlay .documents-upload-choose-button:active`
-   `app\styles\theme\hc.css:671` — `html[data-contrast="hc"] #nav-meist`
-   `app\styles\theme\hc.css:678` — `html[data-contrast="hc"] #nav-meist:hover`
-   `app\styles\theme\hc.css:678` — `html[data-contrast="hc"] #nav-meist:focus-visible`
-   `app\styles\theme\hc.css:825` — `html[data-contrast="hc"] .subscription-content :is(.fancy-checkbox--otp .box, .fancy-checkbox--otp .tick)`
-   `app\styles\theme\hc.css:831` — `html[data-contrast="hc"] .subscription-content .fancy-checkbox--otp .text`
-   `app\styles\theme\hc.css:1107` — `html[data-contrast="hc"] :is(
    .register-content,
...
-   `app\styles\theme\hc.css:1135` — `html[data-contrast="hc"] .invite-modal-content [data-control-type][data-checked="true"]`
-   `app\styles\theme\hc.css:1135` — `html[data-contrast="hc"] .person-invite-modal-content [data-control-type][data-checked="true"]`
-   `app\styles\theme\hc.css:1149` — `html[data-contrast="hc"] .invite-modal-content [data-control-type][data-checked="true"]::before`
-   `app\styles\theme\hc.css:1149` — `html[data-contrast="hc"] .person-invite-modal-content [data-control-type][data-checked="true"]::before`
-   `app\styles\theme\hc.css:1154` — `html[data-contrast="hc"] body .chat-analysis-panel-card .chat-analysis-action-btn.button[data-variant="primary"]`
-   `app\styles\theme\hc.css:1162` — `html[data-contrast="hc"] body .chat-analysis-panel-card .chat-analysis-action-btn.button[data-variant="primary"]::before`
-   `app\styles\theme\hc.css:1165` — `html[data-contrast="hc"] body .chat-analysis-panel-card .chat-analysis-action-btn.button[data-variant="primary"]:is(:hover, :focus-visible)`
-   `app\styles\theme\hc.css:1171` — `html[data-contrast="hc"] body .chat-analysis-panel-card .chat-analysis-action-btn.button[data-variant="primary"]:active`
-   `app\styles\theme\hc.css:1177` — `html[data-contrast="hc"] .invite-modal-content .invite-list-panel`
-   `app\styles\theme\hc.css:1181` — `html[data-contrast="hc"] .invite-modal-content .invite-list-row`
-   `app\styles\theme\hc.css:1185` — `html[data-contrast="hc"] .help-listings-modal-content .help-listings-panel`
-   `app\styles\theme\hc.css:1193` — `html[data-contrast="hc"] .help-listings-modal-content .help-listings-item-card`
-   `app\styles\theme\hc.css:1199` — `html[data-contrast="hc"] .help-listings-modal-content .help-listings-item-card:is(:hover, :focus-visible, :focus-within)`
-   `app\styles\theme\hc.css:1204` — `html[data-contrast="hc"] #login-modal`
-   `app\styles\theme\hc.css:1235` — `html[data-contrast="hc"] #login-modal.login-modal--otp`
-   `app\styles\theme\hc.css:1243` — `html[data-contrast="hc"] #login-modal`
-   `app\styles\theme\hc.css:1263` — `html[data-contrast="hc"] #login-modal .login-modal-shell`
-   `app\styles\theme\hc.css:1267` — `html[data-contrast="hc"] #login-modal.login-modal--otp .login-modal-shell`
-   `app\styles\theme\hc.css:1271` — `html[data-contrast="hc"] #login-modal .login-modal-title`
-   `app\styles\theme\hc.css:1274` — `html[data-contrast="hc"] #login-modal :is(h1, h2, h3, h4, p, span, label, legend, li, a, button, strong, em)`
-   `app\styles\theme\hc.css:1277` — `html[data-contrast="hc"] #login-modal :is(input:not([type="hidden"]):not([aria-hidden="true"]), textarea, select)`
-   `app\styles\theme\hc.css:1284` — `html[data-contrast="hc"] #login-modal :is(input:not([type="hidden"]):not([aria-hidden="true"]), textarea, select)::placeholder`
-   `app\styles\theme\hc.css:1287` — `html[data-contrast="hc"] #login-modal.login-modal--otp .login-otp-content :is(p, span, label, strong, em, a, button)`
-   `app\styles\theme\hc.css:1290` — `html[data-contrast="hc"] #login-modal.login-modal--otp .login-otp-remember`
-   `app\styles\theme\hc.css:1295` — `html[data-contrast="hc"] #login-modal :is(.button, .btn, button[type="submit"], .no-click-pulse)`
-   `app\styles\theme\hc.css:1305` — `html[data-contrast="hc"] #login-modal :is(.button, .btn, button[type="submit"], .no-click-pulse):hover` _(@media (hover: hover))_
-   `app\styles\theme\hc.css:1311` — `html[data-contrast="hc"] #login-modal :is(.button, .btn, button[type="submit"], .no-click-pulse):focus-visible`
-   `app\styles\theme\hc.css:1318` — `html[data-contrast="hc"] #login-modal :is(.button, .btn, button[type="submit"], .no-click-pulse):active`
-   `app\styles\theme\hc.css:1323` — `html[data-contrast="hc"] #login-modal .no-click-pulse`
-   `app\styles\theme\hc.css:1326` — `html[data-contrast="hc"] #login-modal .login-keypad-btn`
-   `app\styles\theme\hc.css:1329` — `html[data-contrast="hc"] #login-modal .login-keypad-btn:is(:hover, :focus-visible, :active)`
-   `app\styles\theme\hc.css:1332` — `html[data-contrast="hc"] #login-modal :is(a, .home-link, .pin-layout-toggle)`
-   `app\styles\theme\hc.css:1332` — `html[data-contrast="hc"] #login-modal :is(a, .home-link, .pin-layout-toggle):is(:hover, :focus-visible, :active)`
-   `app\styles\theme\hc.css:1340` — `html[data-contrast="hc"] #login-modal .pin-layout-toggle`
-   `app\styles\theme\hc.css:1340` — `html[data-contrast="hc"] #login-modal .pin-layout-toggle:is(:hover, :focus-visible, :active)`
-   `app\styles\theme\hc.css:1349` — `html[data-contrast="hc"] #login-modal :is(.button, .btn, button[type="submit"], .no-click-pulse):hover` _(@media (hover: none))_
-   `app\styles\theme\hc.css:1354` — `html[data-contrast="hc"] #login-modal .no-click-pulse:hover` _(@media (hover: none))_
-   `app\styles\theme\hc.css:1360` — `html[data-contrast="hc"] #login-modal :is(.login-modal-close.modal-close-btn, .login-help-close-btn, .login-email-icon-btn)`
-   `app\styles\theme\hc.css:1366` — `html[data-contrast="hc"] #login-modal :is(.login-modal-close.modal-close-btn, .login-help-close-btn, .login-email-icon-btn):is(:hover, :focus-visible, :active)`
-   `app\styles\theme\hc.css:1372` — `html[data-contrast="hc"] #login-modal .login-modal-close.modal-close-btn::before`
-   `app\styles\theme\hc.css:1375` — `html[data-contrast="hc"] #login-modal .login-email-icon :is(path, circle, line, rect, ellipse, polyline, polygon)`
-   `app\styles\theme\hc.css:1378` — `html[data-contrast="hc"] #login-modal .login-email-icon [fill]:not([fill="none"])`
-   `app\styles\theme\hc.css:1378` — `html[data-contrast="hc"] #login-modal .login-submit-icon [fill]:not([fill="none"])`
-   `app\styles\theme\hc.css:1382` — `html[data-contrast="hc"] #login-modal .login-submit-icon :is(path, circle, line, rect, ellipse, polyline, polygon)`
-   `app\styles\theme\hc.css:1385` — `html[data-contrast="hc"] #login-modal .login-submit-dots > span`
-   `app\styles\theme\hc.css:1389` — `html[data-contrast="hc"] #login-modal .login-help-popover`
-   `app\styles\theme\hc.css:1394` — `html[data-contrast="hc"] #login-modal :is(.fancy-checkbox--otp .box, .fancy-checkbox--otp .tick)`
-   `app\styles\theme\hc.css:1399` — `html[data-contrast="hc"] #login-modal :is(.fancy-checkbox--otp .text, #otp-deadline)`
-   `app\styles\theme\hc.css:1536` — `html[data-contrast="hc"]
  body
  .profile-orbit-mobile-panel
...
-   `components\CenteredScrollPicker.css:39` — `.csp-desktop-free-scroll .csp-item`
-   `components\CenteredScrollPicker.css:70` — `.rooms-scroll.csp-container.csp-desktop-free-scroll`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:64` — `.profile-orbit-mobile-action__label`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:107` — `.profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:202` — `:root.theme-light:not(.theme-mid)
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-stack-bubble.dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:202` — `:root.theme-light:not(.theme-mid)
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:345` — `:root.theme-light:not(.theme-mid)
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:345` — `:root.theme-mid
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:479` — `:root:not(.theme-light)
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:531` — `:root:not(.theme-light):not(.theme-mid)
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:592` — `:root:not(.theme-light):not(.theme-mid):not(.theme-night)
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:676` — `:root.theme-light:not(.theme-mid)
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:689` — `:root.theme-mid
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:708` — `:root.theme-night
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:708` — `html[data-contrast="hc"]
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1070` — `:root[data-theme-switching="1"]
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  :is(.profile-orbit-menu__item, .profile-orbit-menu__center, .profile-orbit-stack-bubble).dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1209` — `.profile-orbit-mobile-backdrop.invite-modal-backdrop`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1215` — `.profile-orbit-mobile-panel.invite-modal`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1221` — `.profile-orbit-mobile-panel.invite-modal::before`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1241` — `.profile-orbit-mobile-close.invite-modal__close.modal-close-btn`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1245` — `.profile-orbit-mobile-close.invite-modal__close.modal-close-btn:active`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1249` — `.profile-orbit-mobile-panel
  .dock-item:not(.profile-orbit-stack-bubble):hover`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1249` — `.profile-orbit-mobile-panel
  .dock-item:not(.profile-orbit-stack-bubble):focus-visible`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1255` — `.profile-orbit-mobile-panel
  .dock-item:not(.profile-orbit-mobile-action):not(.profile-orbit-stack-bubble):active`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1260` — `.profile-orbit-mobile-action.dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1281` — `.profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.profile-orbit-edge-glow.dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1286` — `.profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.profile-orbit-edge-glow.dock-item[data-orbit-mobile-active="true"]`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1309` — `.profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-menu.is-open
  .profile-orbit-menu__item.profile-orbit-edge-glow.dock-item
  > .profile-orbit-static-glow`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1316` — `.profile-email-dock-wrapper.profile-orbit-menu-wrapper
  :is(.profile-orbit-menu__item, .profile-orbit-mobile-action, .profile-orbit-stack-bubble).profile-orbit-edge-glow.dock-item:is(:hover, :focus-visible, :active, [data-orbit-mobile-active="true"])
  > .profile-orbit-static-glow`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1388` — `:root.theme-light:not(.theme-mid):not([data-contrast="hc"])
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-menu.is-open
  .profile-orbit-menu__item.profile-orbit-edge-glow.dock-item
  > .profile-orbit-static-glow`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1388` — `:root.theme-mid:not([data-contrast="hc"])
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-menu.is-open
  .profile-orbit-menu__item.profile-orbit-edge-glow.dock-item
  > .profile-orbit-static-glow`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1401` — `:root.theme-light:not(.theme-mid):not([data-contrast="hc"])
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  :is(.profile-orbit-menu__item, .profile-orbit-mobile-action, .profile-orbit-stack-bubble).profile-orbit-edge-glow.dock-item:is(:hover, :focus-visible, :active, [data-orbit-mobile-active="true"])
  > .profile-orbit-static-glow`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1401` — `:root.theme-mid:not([data-contrast="hc"])
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  :is(.profile-orbit-menu__item, .profile-orbit-mobile-action, .profile-orbit-stack-bubble).profile-orbit-edge-glow.dock-item:is(:hover, :focus-visible, :active, [data-orbit-mobile-active="true"])
  > .profile-orbit-static-glow`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1419` — `.profile-orbit-mobile-action.dock-item .dock-icon svg`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1432` — `.profile-orbit-mobile-panel .profile-orbit-mobile-action.dock-item .dock-icon`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1435` — `.profile-orbit-mobile-panel .profile-orbit-mobile-action.dock-item svg`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1439` — `.profile-orbit-mobile-panel
  .profile-orbit-mobile-action.dock-item
  svg
  [fill]:not([fill="none"])`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1445` — `.profile-orbit-mobile-action.dock-item
  .dock-icon
  svg
  [fill]:not([fill="none"])`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1451` — `.profile-orbit-mobile-row.is-active
  .profile-orbit-mobile-action.dock-item
  .dock-icon
  svg`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1459` — `html[data-contrast="hc"]
  .profile-orbit-mobile-panel
  .profile-orbit-mobile-action.dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1459` — `html[data-contrast="hc"]
  .profile-orbit-mobile-panel
...
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1459` — `html[data-contrast="hc"]
  .profile-orbit-mobile-panel
  .profile-orbit-mobile-action.dock-item[data-orbit-mobile-active="true"]`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1475` — `:root .profile-orbit-mobile-scrim--top`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1486` — `:root .profile-orbit-mobile-scrim--bottom`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1497` — `:root:not(.theme-light) .profile-orbit-mobile-chevron`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1529` — `.profile-orbit-mobile-visual` _(@media (prefers-reduced-motion: reduce))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1529` — `.profile-orbit-mobile-scrim` _(@media (prefers-reduced-motion: reduce))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1529` — `.profile-orbit-mobile-chevron` _(@media (prefers-reduced-motion: reduce))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1529` — `.profile-orbit-mobile-action__label` _(@media (prefers-reduced-motion: reduce))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1529` — `.profile-orbit-mobile-close` _(@media (prefers-reduced-motion: reduce))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1537` — `.profile-orbit-mobile-chevron` _(@media (prefers-reduced-motion: reduce))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1548` — `.profile-orbit-stack-item` _(@media (max-width: 48em))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1552` — `.profile-orbit-stack-item[data-key="back"] .profile-orbit-stack-label` _(@media (max-width: 48em))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1556` — `.profile-orbit-mobile-row[data-key="back"] .profile-orbit-mobile-action__label` _(@media (max-width: 48em))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1560` — `.profile-email-dock-wrapper.profile-orbit-menu-wrapper
    .profile-orbit-menu.is-mobile
    .dock-label` _(@media (max-width: 48em))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1566` — `.profile-email-dock-wrapper.profile-orbit-menu-wrapper
    .profile-orbit-stack-item` _(@media (max-width: 48em))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1566` — `.profile-email-dock-wrapper.profile-orbit-menu-wrapper
    .profile-orbit-stack-label` _(@media (max-width: 48em))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1566` — `.profile-email-dock-wrapper.profile-orbit-menu-wrapper
    .profile-orbit-stack-bubble.dock-item` _(@media (max-width: 48em))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1577` — `.profile-email-dock-wrapper.profile-orbit-menu-wrapper
    .profile-orbit-stack-bubble.dock-item::before` _(@media (max-width: 48em))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1582` — `.profile-email-dock-wrapper.profile-orbit-menu-wrapper
    .profile-orbit-stack-bubble
    .dock-icon
    .profile-orbit-back-icon` _(@media (max-width: 48em))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1591` — `.profile-email-dock-wrapper.profile-orbit-menu-wrapper
    .profile-orbit-stack-bubble.dock-item` _(@media (max-width: 48em))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1596` — `:root.theme-light:not(.theme-mid)
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-stack-bubble.dock-item` _(@media (max-width: 48em))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1602` — `html[data-contrast="hc"]
  .profile-orbit-mobile-visual[data-orbit-mobile-active="true"]` _(@media (max-width: 48em))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1609` — `html[data-contrast="hc"]
  .profile-orbit-mobile-panel
  .profile-orbit-mobile-row:not(.is-hidden)
  .profile-orbit-mobile-visual` _(@media (max-width: 48em))_
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1625` — `html[data-contrast="hc"]
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-stack-bubble.dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1625` — `html[data-contrast="hc"]
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1637` — `html[data-contrast="hc"]
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-stack-bubble.dock-item:is(:hover, :focus-visible, :active)`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1691` — `.profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item:is(:hover, :focus-visible, :active)`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1691` — `.profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item[data-orbit-mobile-active="true"]`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1698` — `:root.theme-mid
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item:is(:hover, :focus-visible, :active)`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1698` — `:root.theme-mid
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item[data-orbit-mobile-active="true"]`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1728` — `html[data-contrast="hc"]
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1785` — `html[data-contrast="hc"]
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  :is(
    .profile-orbit-menu__item,
    .profile-orbit-stack-bubble,
    .profile-orbit-mobile-action
  ).dock-item:is(:hover, :focus-visible, :active, [data-orbit-mobile-active="true"])`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1845` — `html[data-contrast="hc"]
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  :is(
    .profile-orbit-menu__item,
    ...
    .profile-orbit-stack-bubble,
    .profile-orbit-mobile-action
  ).profile-orbit-edge-glow.dock-item:is(
    :hover,
    :focus-visible,
    :active,
    [data-orbit-mobile-active="true"]
  )`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1908` — `:root.theme-mono:not([data-contrast="hc"])
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item
  .dock-icon`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1918` — `:root.theme-mono:not([data-contrast="hc"])
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action__label`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1918` — `:root.theme-mono:not([data-contrast="hc"])
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-stack-label`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1930` — `:root.theme-mono:not([data-contrast="hc"])
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item
  .dock-icon
  :is(svg, path, circle, rect, line, polyline, polygon)`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1943` — `:root.theme-mono:not([data-contrast="hc"])
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  .profile-orbit-mobile-action.dock-item
  .dock-icon
  :is(path, circle, rect, polygon)[fill]:not([fill="none"])`
-   `components\effects\Components\OrbitalMenu\OrbitalMenu.css:1984` — `:root.theme-mono:not([data-contrast="hc"])
  .profile-email-dock-wrapper.profile-orbit-menu-wrapper
  :is(
    .profile-orbit-menu__item,
    .profile-orbit-stack-bubble,
...
-   `components\TextAnimations\CircularText\CircularText.css:36` — `.circular-text-svg[data-animate="0"] .circular-text-line`
-   `components\TextAnimations\CircularText\CircularText.css:126` — `.circular-text-svg[data-animate="0"] .word1`
-   `components\TextAnimations\CircularText\CircularText.css:126` — `.circular-text-svg[data-animate="0"] .word2`
-   `components\TextAnimations\CircularText\CircularText.css:126` — `.circular-text-svg[data-animate="0"] .word3`

## Dead — state changes nothing — 64
...
-   `app\styles\theme\hc.css:51` — `#main:focus`
-   `app\styles\theme\hc.css:54` — `.three-d-card .card-face.back:focus`
-   `app\styles\theme\hc.css:539` — `html[data-contrast="hc"] body .home-card-a11y-button:is(:hover, :focus, :active)`
...
## Kept — known runtime-dynamic (NOT dead) — 36
_Matched a css-effective-audit.ignore.json pattern: renders via JS-injected/template-literal classes the crawl can't exercise._
