...
- **<button>** [visible] semantic: `button ui-glow-button-frame ui-glow-button-control` · modules: BorderGlow-module
  ...
  - computed: backgroundImage=radial-gradient(82% 66% at 50% 16… · color=rgb(43, 38, 32) · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0.13) 0px 4px 10px … · borderTopLeftRadius=999px · minHeight=45.6px · opacity=1 · transform=matrix3d(1, 0, 0, 0, 0, 1, 0, 0, … · outlineColor=rgb(43, 38, 32) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
...
- **<button>** [visible] semantic: `button ui-glow-button-frame ui-glow-button-control` · modules: BorderGlow-module
  ...
  - hover Δ: color=rgba(228, 220, 220, 0.965) · boxShadow=rgba(0, 0, 0, 0.125) 0px 4.20436p… · outlineColor=rgba(228, 220, 220, 0.965)
