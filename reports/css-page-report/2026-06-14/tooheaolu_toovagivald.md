# /tooheaolu/toovagivald — primitive CSS report
...
- **<button>** [visible] semantic: `button ui-glow-button-frame ui-glow-button-control` · modules: BorderGlow-module
  ...
  - hover Δ: color=rgba(221, 188, 188, 0.976) · boxShadow=rgba(0, 0, 0, 0.12) 0px 4.89161px… · outlineColor=rgba(221, 188, 188, 0.976)
