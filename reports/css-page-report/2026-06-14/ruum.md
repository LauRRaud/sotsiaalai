# /ruum — primitive CSS report

## light

### `.cs-delete` ×4

- **<button>** [visible] semantic: `cs-delete rooms-delete-btn`
  - tailwind (26): `inline-flex h-[2rem] w-[2rem] items-center justify-center rounded-full border px-0 py-0 transition-[border-co…`
  - computed: backgroundColor=rgba(255, 255, 255, 0.48) · color=rgb(51, 65, 85) · borderTopColor=rgba(255, 255, 255, 0.42) · borderTopWidth=0.8px · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0) 0px 0px 0px 0px,… · borderTopLeftRadius=2.68435e+07px · minHeight=auto · opacity=1 · outlineColor=rgb(51, 65, 85) · position=static · visibility=visible
  ...
  - hover Δ: backgroundColor=rgba(255, 250, 248, 0.62) · color=rgb(154, 83, 77) · borderTopColor=rgba(197, 113, 113, 0.48) · boxShadow=rgba(0, 0, 0, 0) 0px 0px 0px 0px,… · outlineColor=rgb(154, 83, 77)
  - dead@state: `cs-delete rooms-delete-btn`
  - focus-visible:
