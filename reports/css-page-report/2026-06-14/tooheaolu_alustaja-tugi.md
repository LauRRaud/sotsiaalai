# /tooheaolu/alustaja-tugi — primitive CSS report
...
- **<button>** [visible] semantic: `button ui-glow-button-frame ui-glow-button-control` · modules: BorderGlow-module
  ...
  - hover Δ: color=rgba(228, 220, 220, 0.965) · boxShadow=rgba(0, 0, 0, 0.125) 0px 4.20534p… · outlineColor=rgba(228, 220, 220, 0.965)
