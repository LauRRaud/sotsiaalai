# /tooheaolu/toopiirid — primitive CSS report
...
- **<button>** [visible] semantic: `button ui-glow-button-frame ui-glow-button-control` · modules: BorderGlow-module
  ...
  - hover Δ: color=rgba(215, 159, 159, 0.992) · boxShadow=rgba(0, 0, 0, 0.114) 0px 5.52548p… · outlineColor=rgba(215, 159, 159, 0.992)
