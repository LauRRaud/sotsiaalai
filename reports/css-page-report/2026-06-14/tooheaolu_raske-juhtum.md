# /tooheaolu/raske-juhtum — primitive CSS report
...
- **<button>** [visible] semantic: `button ui-glow-button-frame ui-glow-button-control` · modules: BorderGlow-module
  ...
  - hover Δ: color=rgba(218, 177, 177, 0.984) · boxShadow=rgba(0, 0, 0, 0.118) 0px 5.13716p… · outlineColor=rgba(218, 177, 177, 0.984)
