# /tooheaolu/tooprotsessid — primitive CSS report
...
- **<button>** [visible] semantic: `button ui-glow-button-frame ui-glow-button-control` · modules: BorderGlow-module
  ...
  - hover Δ: color=rgba(226, 211, 211, 0.97) · boxShadow=rgba(0, 0, 0, 0.125) 0px 4.40558p… · outlineColor=rgba(226, 211, 211, 0.97)
