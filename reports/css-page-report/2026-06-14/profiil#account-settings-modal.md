# /profiil#account-settings-modal — primitive CSS report

## light

### `.button[data-variant="primary"]` ×2

- **<button>** [visible] semantic: `button ui-glow-button-frame ui-glow-button-control account-settings-modal-button shrink-0` · modules: BorderGlow-module
  - tailwind (72): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(82% 66% at 50% 16… · color=rgb(31, 41, 55) · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0.13) 0px 4px 10px … · borderTopLeftRadius=999px · minHeight=41.6px · opacity=1 · transform=matrix3d(1, 0, 0, 0, 0, 1, 0, 0, … · outlineColor=rgb(31, 41, 55) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
  ...
  - dead@state: `button ui-glow-button-control account-settings-modal-button shrink-0`
  - resting:
...
### `.button[data-variant="danger"]` ×1

- **<button>** [visible] semantic: `button account-settings-modal-button shrink-0`
  - tailwind (82): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=linear-gradient(rgba(194, 54, 54,… · color=rgb(255, 246, 246) · borderTopColor=rgba(154, 43, 43, 0.24) · boxShadow=rgba(0, 0, 0, 0) 0px 0px 0px 0px,… · borderTopLeftRadius=2.68435e+07px · minHeight=41.6px · opacity=1 · outlineColor=rgb(255, 246, 246) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
  - tokens: --btn-primary-bg=radial-gradient(82% 66% at 50% 16… · --btn-primary-bg-hover=radial-gradient(82% 66% at 50% 16… · --btn-primary-text=#1f2937eb · --btn-primary-shadow=0 4px 10px #00000021 · --btn-primary-border=0 solid transparent
  - hover Δ: borderTopColor=rgba(154, 43, 43, 0.32) · boxShadow=rgba(0, 0, 0, 0) 0px 0px 0px 0px,…
  - dead@state: `button account-settings-modal-button shrink-0`
  - focus-visible:
    - _0blu2ae._.css | :where(a, button, input, select, textarea, [role], [tab… → [outline-color]

### `.back-button` ×2

- **<button>** [visible] semantic: `back-button bg-transparent p-0 group glass-subpage-back-button profile-back-button pointer-events-auto`
  - tailwind (28): `inline-flex h-[5.7rem] w-[5.7rem] min-[769px]:h-[6.4rem] min-[769px]:w-[6.4rem] items-center justify-center b…`
  ...
  - tokens: --btn-primary-bg=radial-gradient(82% 66% at 50% 16… · --btn-primary-bg-hover=radial-gradient(82% 66% at 50% 16… · --btn-primary-text=#1f2937eb · --btn-primary-shadow=0 4px 10px #00000021 · --btn-primary-border=0 solid transparent
  - dead@state: `p-0 group glass-subpage-back-button profile-back-button pointer-events-auto`
  - resting:
...
- **<button>** [visible] semantic: `back-button bg-transparent p-0 group glass-subpage-back-button account-settings-back-button`
  - tailwind (28): `inline-flex h-[5.7rem] w-[5.7rem] min-[769px]:h-[6.4rem] min-[769px]:w-[6.4rem] items-center justify-center b…`
  - computed: color=rgb(255, 255, 255) · borderTopColor=rgb(255, 255, 255) · borderTopStyle=solid · borderTopLeftRadius=999px · opacity=1 · outlineColor=rgb(255, 255, 255) · position=absolute · visibility=visible
  - tokens: --btn-primary-bg=radial-gradient(82% 66% at 50% 16… · --btn-primary-bg-hover=radial-gradient(82% 66% at 50% 16… · --btn-primary-text=#1f2937eb · --btn-primary-shadow=0 4px 10px #00000021 · --btn-primary-border=0 solid transparent
  - dead@state: `p-0 group glass-subpage-back-button account-settings-back-button`
  - resting:
    - _0blu2ae._.css | .back-button → [border-top-left-radius,border-top-right-radius,border-bottom-right-radius,border-bottom-left-radius]
  - focus-visible:
    - _0blu2ae._.css | :where(a, button, input, select, textarea, [role], [tab… → [outline-color]

### `.account-settings-modal-content .button[data-variant="primary"]` ×2
...
### `.account-settings-modal-button` ×3
...
- **<button>** [visible] semantic: `button ui-glow-button-frame ui-glow-button-control account-settings-modal-button shrink-0` · modules: BorderGlow-module
  - tailwind (72): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(92% 88% at 50% 16… · color=rgb(63, 71, 86) · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0.13) 0px 4px 10px … · borderTopLeftRadius=999px · minHeight=41.6px · opacity=1 · transform=matrix3d(1, 0, 0, 0, 0, 1, 0, 0, … · outlineColor=rgb(63, 71, 86) · position=relative · visibility=visible
...
- **<button>** [visible] semantic: `button ui-glow-button-frame ui-glow-button-control account-settings-modal-button shrink-0` · modules: BorderGlow-module
  ...
  - tokens: --btn-primary-bg=radial-gradient(92% 88% at 50% 16… · --btn-primary-bg-hover=radial-gradient(92% 88% at 50% 16… · --btn-primary-text=#2f3a4a · --btn-primary-shadow=0 4px 10px #00000021 · --btn-primary-border=0 solid transparent
  - hover Δ: boxShadow=rgba(38, 24, 22, 0.1) 0px 7px 16p…
  - dead@state: `ui-glow-button-control account-settings-modal-button shrink-0`
  - resting:
    - _0blu2ae._.css | :root.theme-mid .button[data-variant="primary"] → [--btn-primary-bg-hover,--btn-primary-bg-active,--btn-primary-border-hover,--btn-primary-shadow-hover,backdrop-filter!,background-image!,background-position-x!,background-position-y!,background-size!,background-repeat!,background-attachment!,background-origin!,background-clip!,background-color!,border-top-color!,border-top-style!,border-top-width!,border-right-color!,border-right-style!,border-right-width!,border-bottom-color!,border-bottom-style!,border-bottom-width!,border-left-color!,border-left-style!,border-left-width!,border-image-source!,border-image-slice!,border-image-width!,border-image-outset!,border-image-repeat!,box-shadow!]
    - _0blu2ae._.css | :root.theme-mid .button[data-variant="primary"]::before → [background-image!,background-position-x!,background-position-y!,background-size!,background-repeat!,background-attachment!,background-origin!,background-clip!,background-color!]
    - _0blu2ae._.css | .ui-glow-button-frame → [color,border-top-left-radius,border-top-right-radius,border-bottom-right-radius,border-bottom-left-radius]
...
- **<button>** [visible] semantic: `button ui-glow-button-frame ui-glow-button-control account-settings-modal-button shrink-0` · modules: BorderGlow-module
  - tailwind (72): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(82% 66% at 50% -1… · color=rgb(242, 242, 242) · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0.13) 0px 4px 10px … · borderTopLeftRadius=999px · minHeight=41.6px · opacity=1 · transform=matrix3d(1, 0, 0, 0, 0, 1, 0, 0, … · outlineColor=rgb(242, 242, 242) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
...
- **<button>** [visible] semantic: `button account-settings-modal-button shrink-0`
  - tailwind (82): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=linear-gradient(rgba(167, 36, 36,… · color=rgb(255, 244, 244) · borderTopColor=rgba(255, 184, 184, 0.28) · boxShadow=rgba(0, 0, 0, 0) 0px 0px 0px 0px,… · borderTopLeftRadius=2.68435e+07px · minHeight=41.6px · opacity=1 · outlineColor=rgb(255, 244, 244) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
  - tokens: --btn-primary-bg=radial-gradient(82% 66% at 50% -1… · --btn-primary-bg-hover=radial-gradient(82% 66% at 50% -1… · --btn-primary-text=#f8fcfff5 · --btn-primary-shadow=0 4px 10px #00000021 · --btn-primary-border=0 solid transparent
  - hover Δ: borderTopColor=rgba(255, 214, 214, 0.38) · boxShadow=rgba(0, 0, 0, 0) 0px 0px 0px 0px,…
  - dead@state: `button account-settings-modal-button shrink-0`
  - focus-visible:
    - _0blu2ae._.css | :where(a, button, input, select, textarea, [role], [tab… → [outline-color]
...
- **<button>** [visible] semantic: `button ui-glow-button-frame ui-glow-button-control account-settings-modal-button shrink-0` · modules: BorderGlow-module
  - tailwind (72): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(118% 102% at 50% … · color=rgba(230, 230, 230, 0.96) · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0.13) 0px 4px 10px … · borderTopLeftRadius=999px · minHeight=41.6px · opacity=1 · transform=matrix3d(1, 0, 0, 0, 0, 1, 0, 0, … · outlineColor=rgba(230, 230, 230, 0.96) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
  ...
  - hover Δ: color=rgba(227, 217, 217, 0.965) · boxShadow=rgba(0, 0, 0, 0.125) 0px 4.27276p… · outlineColor=rgba(227, 217, 217, 0.965)
  - dead@state: `button ui-glow-button-frame ui-glow-button-control account-settings-modal-button shrink-0`
  - resting:
    - _0blu2ae._.css | .ui-glow-button-frame → [color,border-top-left-radius,border-top-right-radius,border-bottom-right-radius,border-bottom-left-radius]
    - _0blu2ae._.css | :root:not(.theme-light):not(.theme-mid) .ui-glow-button… → [box-shadow!]
...
- **<button>** [visible] semantic: `button account-settings-modal-button shrink-0`
  - tailwind (82): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(118% 102% at 50% … · color=rgba(230, 230, 230, 0.96) · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0.13) 0px 4px 10px … · borderTopLeftRadius=2.68435e+07px · minHeight=41.6px · opacity=1 · outlineColor=rgba(230, 230, 230, 0.96) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
  - tokens: --btn-primary-bg=radial-gradient(118% 102% at 50% … · --btn-primary-bg-hover=radial-gradient(118% 102% at 50% … · --btn-primary-text=#e6e6e6f5 · --btn-primary-shadow=0 4px 10px #00000021 · --btn-primary-border=0 solid transparent
  - hover Δ: color=rgba(237, 223, 223, 0.98) · borderTopColor=rgba(255, 184, 184, 0.098) · boxShadow=rgba(0, 0, 0, 0.08) 0px 2.78243px… · outlineColor=rgba(237, 223, 223, 0.98)
  - resting:
    - _0blu2ae._.css | :root.theme-mono:not([data-contrast="hc"]) :is(.button,… → [color!,background-image!,background-position-x!,background-position-y!,background-size!,background-repeat!,background-attachment!,background-origin!,background-clip!,background-color!,border-top-color!,border-top-style!,border-top-width!,border-right-color!,border-right-style!,border-right-width!,border-bottom-color!,border-bottom-style!,border-bottom-width!,border-left-color!,border-left-style!,border-left-width!,border-image-source!,border-image-slice!,border-image-width!,border-image-outset!,border-image-repeat!,box-shadow!]
    - _0blu2ae._.css | :root.theme-mono:not([data-contrast="hc"]) :is(.button,… → [border-top-left-radius,border-top-right-radius,border-bottom-right-radius,border-bottom-left-radius,opacity,background-image!,background-position-x!,background-position-y!,background-size!,background-repeat!,background-attachment!,background-origin!,background-clip!,background-color!]
  - focus-visible:
...
- **<button>** [visible] semantic: `button account-settings-modal-button shrink-0`
  - tailwind (82): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(118% 102% at 50% … · color=rgb(255, 244, 244) · borderTopColor=rgba(255, 184, 184, 0.28) · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0) 0px 0px 0px 0px,… · borderTopLeftRadius=2.68435e+07px · minHeight=41.6px · opacity=1 · outlineColor=rgb(255, 244, 244) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
  - tokens: --btn-primary-bg=radial-gradient(118% 102% at 50% … · --btn-primary-bg-hover=radial-gradient(118% 102% at 50% … · --btn-primary-text=#e6e6e6f5 · --btn-primary-shadow=0 4px 10px #00000021 · --btn-primary-border=0 solid transparent
  - hover Δ: borderTopColor=rgba(255, 214, 214, 0.38) · boxShadow=rgba(0, 0, 0, 0) 0px 0px 0px 0px,…
  - dead@state: `account-settings-modal-button shrink-0`
  - resting:
    - _0blu2ae._.css | :root.theme-mono:not([data-contrast="hc"]) :is(.button,… → [color!,background-image!,background-position-x!,background-position-y!,background-size!,background-repeat!,background-attachment!,background-origin!,background-clip!,background-color!,border-top-color!,border-top-style!,border-top-width!,border-right-color!,border-right-style!,border-right-width!,border-bottom-color!,border-bottom-style!,border-bottom-width!,border-left-color!,border-left-style!,border-left-width!,border-image-source!,border-image-slice!,border-image-width!,border-image-outset!,border-image-repeat!,box-shadow!]
    - _0blu2ae._.css | :root.theme-mono:not([data-contrast="hc"]) :is(.button,… → [border-top-left-radius,border-top-right-radius,border-bottom-right-radius,border-bottom-left-radius,opacity,background-image!,background-position-x!,background-position-y!,background-size!,background-repeat!,background-attachment!,background-origin!,background-clip!,background-color!]
  - focus-visible:
...
- **<button>** [visible] semantic: `button ui-glow-button-frame ui-glow-button-control account-settings-modal-button shrink-0` · modules: BorderGlow-module
  - tailwind (72): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(124% 96% at 50% 6… · color=rgb(255, 234, 0) · borderTopColor=rgba(255, 234, 0, 0.66) · borderTopWidth=1.6px · borderTopStyle=solid · borderTopLeftRadius=999px · minHeight=41.6px · opacity=1 · transform=matrix3d(1, 0, 0, 0, 0, 1, 0, 0, … · outlineColor=rgb(255, 234, 0) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
  - tokens: --btn-primary-bg=radial-gradient(82% 66% at 50% -1… · --btn-primary-bg-hover=linear-gradient(0deg,
      #ffea… · --btn-primary-text=#ffea00 · --btn-primary-shadow=inset 0 1px 0 #dcecff1a,
  ...
  - resting:
    ...
    - _0blu2ae._.css | html[data-contrast="hc"] :is(.register-content, .invite… → [color!]
    - _0blu2ae._.css | html[data-contrast="hc"] :is(.register-content, .invite… → [color!,box-shadow!,border-top-color!,border-right-color!,border-bottom-color!,border-left-color!]
    - _0blu2ae._.css | html[data-contrast="hc"] body :is(button, [role="button… → [color!,background-image!,background-position-x!,background-position-y!,background-size!,background-repeat!,background-attachment!,background-origin!,background-clip!,background-color!,box-shadow!,border-top-color!,border-right-color!,border-bottom-color!,border-left-color!]
  ...
  - active:
    - _0blu2ae._.css | html[data-contrast="hc"] :is(.register-content, .invite… → [box-shadow!,border-top-color!,border-right-color!,border-bottom-color!,border-left-color!]
...
- **<button>** [visible] semantic: `button account-settings-modal-button shrink-0`
  - tailwind (82): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(124% 96% at 50% 6… · color=rgb(255, 234, 0) · borderTopColor=rgba(255, 234, 0, 0.66) · borderTopWidth=1.6px · borderTopStyle=solid · borderTopLeftRadius=2.68435e+07px · minHeight=41.6px · opacity=1 · outlineColor=rgb(255, 234, 0) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
  - tokens: --btn-primary-bg=radial-gradient(82% 66% at 50% -1… · --btn-primary-bg-hover=linear-gradient(0deg,
      #ffea… · --btn-primary-text=#ffea00 · --btn-primary-shadow=inset 0 1px 0 #dcecff1a,
    0 5p… · --btn-primary-border=2px solid #ffea00a8
  - hover Δ: backgroundImage=linear-gradient(rgba(255, 234, 0,… · borderTopColor=rgba(255, 234, 0, 0.9)
...
- **<button>** [visible] semantic: `back-button bg-transparent p-0 group glass-subpage-back-button profile-back-button pointer-events-auto`
  ...
  - dead@state: `bg-transparent p-0 group glass-subpage-back-button profile-back-button pointer-events-auto`
  - resting:
    - _0blu2ae._.css | .back-button → [border-top-left-radius,border-top-right-radius,border-bottom-right-radius,border-bottom-left-radius]
...
- **<button>** [visible] semantic: `back-button bg-transparent p-0 group glass-subpage-back-button account-settings-back-button`
  ...
  - tokens: --btn-primary-bg=radial-gradient(82% 66% at 50% -1… · --btn-primary-bg-hover=linear-gradient(0deg,
      #ffea… · --btn-primary-text=#ffea00 · --btn-primary-shadow=inset 0 1px 0 #dcecff1a,
    0 5p… · --btn-primary-border=2px solid #ffea00a8
  - dead@state: `bg-transparent p-0 group glass-subpage-back-button account-settings-back-button`
  - resting:
    - _0blu2ae._.css | .back-button → [border-top-left-radius,border-top-right-radius,border-bottom-right-radius,border-bottom-left-radius]
    - _0blu2ae._.css | html[data-contrast="hc"] :is(.register-content, .invite… → [color!]
    - _0blu2ae._.css | html[data-contrast="hc"] body :is(.back-button, .chat-b… → [color!,border-top-color!,border-right-color!,border-bottom-color!,border-left-color!,box-shadow!]
