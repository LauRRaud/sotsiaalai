# /tooheaolu/katkestused — primitive CSS report
...
- **<button>** [visible] semantic: `button ui-glow-button-frame ui-glow-button-control` · modules: BorderGlow-module
  ...
  - hover Δ: color=rgba(213, 153, 153, 0.992) · boxShadow=rgba(0, 0, 0, 0.114) 0px 5.65874p… · outlineColor=rgba(213, 153, 153, 0.992)
