# /tooheaolu/ulevaade — primitive CSS report

## light

### `.button[data-variant="primary"]` ×1

- **<button>** [visible, disabled] semantic: `button ui-glow-button-frame ui-glow-button-control ui-glow-button-frame--disabled` · modules: BorderGlow-module
  - tailwind (57): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(82% 66% at 50% 16… · color=color(srgb 0 0 0 / 0.545882) · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0.13) 0px 4px 10px … · borderTopLeftRadius=12.16px · minHeight=38.72px · opacity=0.6 · transform=matrix3d(1, 0, 0, 0, 0, 1, 0, 0, … · outlineColor=color(srgb 0 0 0 / 0.545882) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
  ...
  - dead@state: `ui-glow-button-control ui-glow-button-frame--disabled`
  - resting:
    ...
    - components_0b3d-an._.css | .WellbeingPage-module__RRRxDq__supportActions .button → [border-top-left-radius!,border-top-right-radius!,border-bottom-right-radius!,border-bottom-left-radius!]
  - focus-visible:
    - _0blu2ae._.css | :where(a, button, input, select, textarea, [role], [tab… → [outline-color]

### `.button[data-variant="secondary"]` ×1
...
- **<button>** [visible, disabled] semantic: `button shadow-none`
  ...
  - computed: backgroundColor=rgba(255, 255, 255, 0.04) · color=color(srgb 0 0 0 / 0.545882) · borderTopWidth=0.8px · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0) 0px 0px 0px 0px,… · borderTopLeftRadius=12.16px · minHeight=38.72px · opacity=0.6 · outlineColor=color(srgb 0 0 0 / 0.545882) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
  - tokens: --btn-primary-bg=radial-gradient(82% 66% at 50% 16… · --btn-primary-bg-hover=radial-gradient(82% 66% at 50% 16… · --btn-primary-text=#243244 · --btn-primary-shadow=0 4px 10px #00000021 · --btn-primary-border=0 solid transparent
  - hover Δ: backgroundColor=rgba(255, 255, 255, 0.08) · color=rgba(0, 0, 0, 0.94) · borderTopColor=rgba(170, 190, 215, 0.38) · opacity=1 · outlineColor=rgba(0, 0, 0, 0.94)
  - resting:
    - components_0b3d-an._.css | .WellbeingPage-module__RRRxDq__page .button[data-varian… → [color!]
    - components_0b3d-an._.css | .WellbeingPage-module__RRRxDq__supportActions .button → [border-top-left-radius!,border-top-right-radius!,border-bottom-right-radius!,border-bottom-left-radius!]
  - focus-visible:
...
- **<button>** [visible, disabled] semantic: `button ui-glow-button-frame ui-glow-button-control ui-glow-button-frame--disabled` · modules: BorderGlow-module
  - tailwind (57): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(92% 88% at 50% 16… · color=color(srgb 0 0 0 / 0.545882) · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0.13) 0px 4px 10px … · borderTopLeftRadius=12.16px · minHeight=38.72px · opacity=0.6 · transform=matrix3d(1, 0, 0, 0, 0, 1, 0, 0, … · outlineColor=color(srgb 0 0 0 / 0.545882) · position=relative · visibility=visible
  ...
  - hover Δ: borderTopColor=rgba(126, 95, 88, 0.043) · boxShadow=rgba(38, 24, 22, 0.1) 0px 7px 16p…
  - resting:
...
- **<button>** [visible, disabled] semantic: `button ui-glow-button-frame ui-glow-button-control ui-glow-button-frame--disabled` · modules: BorderGlow-module
  - tailwind (57): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(82% 66% at 50% -1… · color=color(srgb 1 1 1 / 0.550431) · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0.13) 0px 4px 10px … · borderTopLeftRadius=12.16px · minHeight=38.72px · opacity=0.6 · transform=matrix3d(1, 0, 0, 0, 0, 1, 0, 0, … · outlineColor=color(srgb 1 1 1 / 0.550431) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
...
- **<button>** [visible, disabled] semantic: `button shadow-none`
  - tailwind (42): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundColor=rgba(255, 255, 255, 0.04) · color=color(srgb 1 1 1 / 0.550431) · borderTopWidth=0.8px · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0) 0px 0px 0px 0px,… · borderTopLeftRadius=12.16px · minHeight=38.72px · opacity=0.6 · outlineColor=color(srgb 1 1 1 / 0.550431) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
  - tokens: --btn-primary-bg=radial-gradient(82% 66% at 50% -1… · --btn-primary-bg-hover=radial-gradient(82% 66% at 50% -1… · --btn-primary-text=#243244 · --btn-primary-shadow=0 4px 10px #00000021 · --btn-primary-border=0 solid transparent
  - hover Δ: backgroundColor=rgba(255, 255, 255, 0.08) · color=rgba(255, 255, 255, 0.95) · borderTopColor=rgba(170, 190, 215, 0.38) · opacity=1 · outlineColor=rgba(255, 255, 255, 0.95)
  - resting:
    - components_0b3d-an._.css | .WellbeingPage-module__RRRxDq__page .button[data-varian… → [color!]
    - components_0b3d-an._.css | .WellbeingPage-module__RRRxDq__supportActions .button → [border-top-left-radius!,border-top-right-radius!,border-bottom-right-radius!,border-bottom-left-radius!]
  - focus-visible:
...
- **<button>** [visible, disabled] semantic: `button ui-glow-button-frame ui-glow-button-control ui-glow-button-frame--disabled` · modules: BorderGlow-module
  - tailwind (57): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(118% 102% at 50% … · color=rgba(230, 230, 230, 0.96) · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0.13) 0px 4px 10px … · borderTopLeftRadius=12.16px · minHeight=38.72px · opacity=0.6 · transform=matrix3d(1, 0, 0, 0, 0, 1, 0, 0, … · outlineColor=rgba(230, 230, 230, 0.96) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
  ...
  - hover Δ: color=rgba(228, 220, 220, 0.965) · boxShadow=rgba(0, 0, 0, 0.125) 0px 4.20632p… · outlineColor=rgba(228, 220, 220, 0.965)
  - dead@state: `ui-glow-button-frame ui-glow-button-control ui-glow-button-frame--disabled`
  - resting:
    - _0blu2ae._.css | .ui-glow-button-frame → [color,border-top-left-radius,border-top-right-radius,border-bottom-right-radius,border-bottom-left-radius]
    - _0blu2ae._.css | :root:not(.theme-light):not(.theme-mid) .ui-glow-button… → [box-shadow!]
...
- **<button>** [visible, disabled] semantic: `button shadow-none`
  - tailwind (42): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(118% 102% at 50% … · color=rgba(230, 230, 230, 0.96) · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0.13) 0px 4px 10px … · borderTopLeftRadius=12.16px · minHeight=38.72px · opacity=0.6 · outlineColor=rgba(230, 230, 230, 0.96) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
  - tokens: --btn-primary-bg=radial-gradient(118% 102% at 50% … · --btn-primary-bg-hover=radial-gradient(118% 102% at 50% … · --btn-primary-text=#243244 · --btn-primary-shadow=0 4px 10px #00000021 · --btn-primary-border=0 solid transparent
  - hover Δ: color=rgba(228, 220, 219, 0.99) · boxShadow=rgba(0, 0, 0, 0.05) 0px 1.8711px … · opacity=0.668321 · outlineColor=rgba(228, 220, 219, 0.99)
  - resting:
    - _0blu2ae._.css | :root.theme-mono:not([data-contrast="hc"]) :is(.button,… → [color!,background-image!,background-position-x!,background-position-y!,background-size!,background-repeat!,background-attachment!,background-origin!,background-clip!,background-color!,border-top-color!,border-top-style!,border-top-width!,border-right-color!,border-right-style!,border-right-width!,border-bottom-color!,border-bottom-style!,border-bottom-width!,border-left-color!,border-left-style!,border-left-width!,border-image-source!,border-image-slice!,border-image-width!,border-image-outset!,border-image-repeat!,box-shadow!]
    - _0blu2ae._.css | :root.theme-mono:not([data-contrast="hc"]) :is(.button,… → [border-top-left-radius,border-top-right-radius,border-bottom-right-radius,border-bottom-left-radius,opacity,background-image!,background-position-x!,background-position-y!,background-size!,background-repeat!,background-attachment!,background-origin!,background-clip!,background-color!]
    - components_0b3d-an._.css | .WellbeingPage-module__RRRxDq__page .button[data-varian… → [color!]
...
- **<button>** [visible, disabled] semantic: `button ui-glow-button-frame ui-glow-button-control ui-glow-button-frame--disabled` · modules: BorderGlow-module
  - tailwind (57): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(124% 96% at 50% 6… · color=rgb(255, 234, 0) · borderTopColor=rgba(255, 234, 0, 0.66) · borderTopStyle=solid · borderTopLeftRadius=12.16px · minHeight=38.72px · opacity=0.6 · transform=matrix3d(1, 0, 0, 0, 0, 1, 0, 0, … · outlineColor=rgb(255, 234, 0) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
...
- **<button>** [visible, disabled] semantic: `button shadow-none`
  - tailwind (42): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(124% 96% at 50% 6… · color=rgb(255, 234, 0) · borderTopColor=rgba(255, 234, 0, 0.66) · borderTopStyle=solid · borderTopLeftRadius=12.16px · minHeight=38.72px · opacity=0.6 · outlineColor=rgb(255, 234, 0) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
  - tokens: --btn-primary-bg=radial-gradient(124% 96% at 50% 6… · --btn-primary-bg-hover=linear-gradient(180deg, #ffea0014… · --btn-primary-text=#ffea00 · --btn-primary-shadow=0 4px 10px #00000021 · --btn-primary-border=0 solid transparent
