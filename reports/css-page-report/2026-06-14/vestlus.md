# /vestlus — primitive CSS report

## light

### `.button[data-variant="primary"]` ×4

- **<button>** [hidden] semantic: `button ui-glow-button-frame ui-glow-button-control invite-primary-btn` · modules: BorderGlow-module
  - tailwind (76): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(82% 66% at 50% 16… · color=rgb(31, 41, 55) · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0.13) 0px 4px 10px … · borderTopLeftRadius=999px · minHeight=38.72px · opacity=1 · transform=matrix3d(1, 0, 0, 0, 0, 1, 0, 0, … · outlineColor=rgb(31, 41, 55) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=hidden
...
- **<button>** [hidden] semantic: `button ui-glow-button-frame ui-glow-button-control invite-primary-btn` · modules: BorderGlow-module
  - tailwind (72): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(82% 66% at 50% 16… · color=rgb(31, 41, 55) · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0.13) 0px 4px 10px … · borderTopLeftRadius=999px · minHeight=38.72px · opacity=1 · transform=matrix3d(1, 0, 0, 0, 0, 1, 0, 0, … · outlineColor=rgb(31, 41, 55) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=hidden
  - tokens: --btn-primary-bg=radial-gradient(82% 66% at 50% 16… · --btn-primary-bg-hover=radial-gradient(82% 66% at 50% 16… · --btn-primary-text=#1f2937eb · --btn-primary-shadow=0 4px 10px #00000021 · --btn-primary-border=0 solid transparent
  - hover Δ: backgroundImage=radial-gradient(82% 66% at 50% 16… · boxShadow=rgba(0, 0, 0, 0.11) 0px 6px 13px …
  - dead@state: `button ui-glow-button-control invite-primary-btn`
...
- **<button>** [visible, disabled] semantic: `chat-send-btn invite-primary-btn pointer-events-auto`
  ...
  - computed: backgroundImage=radial-gradient(82% 66% at 50% 16… · color=rgb(31, 41, 55) · borderTopColor=rgb(31, 41, 55) · boxShadow=rgba(15, 23, 42, 0.06) 0px 1px 4p… · borderTopLeftRadius=9999px · minHeight=47.28px · opacity=1 · outlineColor=rgb(31, 41, 55) · position=relative · visibility=visible
...
- **<button>** [visible] semantic: `chat-listen-btn pointer-events-auto chat-dictate-btn`
  - tailwind (22): `relative z-[2] !h-[calc(var(--inputbar-h)-2px)] !w-[calc(var(--inputbar-h)-2px)] !min-h-[calc(var(--inputbar-…`
  - computed: color=rgb(31, 41, 55) · borderTopColor=rgb(31, 41, 55) · borderTopLeftRadius=9999px · minHeight=47.28px · opacity=1 · outlineColor=rgb(31, 41, 55) · position=relative · visibility=visible
  - tokens: --btn-primary-bg=radial-gradient(82% 66% at 50% 16… · --btn-primary-bg-hover=radial-gradient(82% 66% at 50% 16… · --btn-primary-text=#1f2937eb · --btn-primary-shadow=0 4px 10px #0f172a1a · --btn-primary-border=1px solid #94a3b814
  - dead@state: `pointer-events-auto chat-dictate-btn`
  - resting:
    - _0tu9g5d._.css | body .chat-inputbar .chat-listen-btn, body .chat-inputb… → [border-top-left-radius!,border-top-right-radius!,border-bottom-right-radius!,border-bottom-left-radius!]
    - _0tu9g5d._.css | :root.theme-light .chat-inputbar, :root.theme-light .ch… → [--chat-action-size,--chat-inputbar-bg,--chat-inputbar-bg-hover,--chat-inputbar-bg-focus,--chat-inputbar-border,--chat-inputbar-border-hover,--chat-inputbar-shadow,--chat-inputbar-shadow-hover,--chat-inputbar-shadow-focus,--chat-action-btn-bg,--chat-action-btn-bg-hover,--chat-action-btn-bg-active,--chat-action-btn-border,--chat-action-btn-border-active,--chat-action-btn-shadow,--chat-action-btn-shadow-hover,--chat-action-btn-shadow-focus,--chat-action-btn-shadow-active,background-image,background-position-x,background-position-y,background-size,background-repeat,background-attachment,background-origin,background-clip,background-color,border-top-color,border-top-style,border-top-width,border-right-color,border-right-style,border-right-width,border-bottom-color,border-bottom-style,border-bottom-width,border-left-color,border-left-style,border-left-width,border-image-source,border-image-slice,border-image-width,border-image-outset,border-image-repeat,box-shadow,color]
    - _0tu9g5d._.css | :root.theme-light .chat-inputbar .chat-listen-btn → [box-shadow,background-image,background-position-x,background-position-y,background-size,background-repeat,background-attachment,background-origin,background-clip,background-color,border-top-width,border-right-width,border-bottom-width,border-left-width,border-top-style,border-right-style,border-bottom-style,border-left-style,border-top-color,border-right-color,border-bottom-color,border-left-color,border-image-source,border-image-slice,border-image-width,border-image-outset,border-image-repeat]
  - focus-visible:
    - _0blu2ae._.css | :where(a, button, input, select, textarea, [role], [tab… → [outline-color]
  - active:
    - _0tu9g5d._.css | :root.theme-light .chat-inputbar .chat-listen-btn:activ… → [background-image,background-position-x,background-position-y,background-size,background-repeat,background-attachment,background-origin,background-clip,background-color,border-top-color,border-top-style,border-top-width,border-right-color,border-right-style,border-right-width,border-bottom-color,border-bottom-style,border-bottom-width,border-left-color,border-left-style,border-left-width,border-image-source,border-image-slice,border-image-width,border-image-outset,border-image-repeat,box-shadow]
    - _0tu9g5d._.css | :root.theme-light .chat-inputbar .chat-listen-btn:active → [box-shadow,background-image,background-position-x,background-position-y,background-size,background-repeat,background-attachment,background-origin,background-clip,background-color,border-top-width,border-right-width,border-bottom-width,border-left-width,border-top-style,border-right-style,border-bottom-style,border-left-style,border-top-color,border-right-color,border-bottom-color,border-left-color,border-image-source,border-image-slice,border-image-width,border-image-outset,border-image-repeat]
...
- **<button>** [hidden] semantic: `button ui-glow-button-frame ui-glow-button-control invite-primary-btn` · modules: BorderGlow-module
  - tailwind (76): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(92% 88% at 50% 16… · color=rgb(31, 41, 55) · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0.13) 0px 4px 10px … · borderTopLeftRadius=999px · minHeight=38.72px · opacity=1 · transform=matrix3d(1, 0, 0, 0, 0, 1, 0, 0, … · outlineColor=rgb(31, 41, 55) · position=relative · visibility=hidden
...
- **<button>** [visible, disabled] semantic: `chat-send-btn invite-primary-btn pointer-events-auto`
  - tailwind (22): `relative z-[2] !h-[calc(var(--inputbar-h)-2px)] !w-[calc(var(--inputbar-h)-2px)] !min-h-[calc(var(--inputbar-…`
  - computed: backgroundImage=radial-gradient(92% 88% at 50% 16… · color=rgb(47, 58, 74) · borderTopColor=rgb(47, 58, 74) · boxShadow=rgba(38, 24, 22, 0.1) 0px 6px 14p… · borderTopLeftRadius=9999px · minHeight=47.28px · opacity=1 · outlineColor=rgb(47, 58, 74) · position=relative · visibility=visible
  ...
  - resting:
    ...
    - _0tu9g5d._.css | :root.theme-light .chat-inputbar, :root.theme-light .ch… → [--chat-action-size,--chat-inputbar-bg,--chat-inputbar-bg-hover,--chat-inputbar-bg-focus,--chat-inputbar-border,--chat-inputbar-border-hover,--chat-inputbar-shadow,--chat-inputbar-shadow-hover,--chat-inputbar-shadow-focus,--chat-action-btn-bg,--chat-action-btn-bg-hover,--chat-action-btn-bg-active,--chat-action-btn-border,--chat-action-btn-border-active,--chat-action-btn-shadow,--chat-action-btn-shadow-hover,--chat-action-btn-shadow-focus,--chat-action-btn-shadow-active,background-image,background-position-x,background-position-y,background-size,background-repeat,background-attachment,background-origin,background-clip,background-color,border-top-color,border-top-style,border-top-width,border-right-color,border-right-style,border-right-width,border-bottom-color,border-bottom-style,border-bottom-width,border-left-color,border-left-style,border-left-width,border-image-source,border-image-slice,border-image-width,border-image-outset,border-image-repeat,box-shadow,color]
    - _0tu9g5d._.css | :root.theme-light .chat-inputbar .chat-send-btn → [background-image,background-position-x,background-position-y,background-size,background-repeat,background-attachment,background-origin,background-clip,background-color,border-top-width,border-right-width,border-bottom-width,border-left-width,border-top-style,border-right-style,border-bottom-style,border-left-style,border-top-color,border-right-color,border-bottom-color,border-left-color,border-image-source,border-image-slice,border-image-width,border-image-outset,border-image-repeat,box-shadow]
    - _0tu9g5d._.css | :root.theme-mid .chat-inputbar, :root.theme-mid .chat-i… → [--chat-action-size,color,--chat-inputbar-bg,--chat-inputbar-bg-hover,--chat-inputbar-bg-focus,--chat-inputbar-overlay-bg,--chat-inputbar-shadow,--chat-inputbar-shadow-hover,--chat-inputbar-shadow-focus,--chat-inputbar-btn-bg,--chat-inputbar-btn-bg-hover,--chat-inputbar-btn-bg-focus,--chat-inputbar-btn-overlay-bg,--chat-inputbar-btn-shadow,--chat-inputbar-btn-shadow-hover,--chat-inputbar-btn-shadow-focus]
    - _0tu9g5d._.css | :root.theme-mid .chat-inputbar .chat-send-btn → [background-image!,background-position-x!,background-position-y!,background-size!,background-repeat!,background-attachment!,background-origin!,background-clip!,background-color!,box-shadow!,backdrop-filter!,border-top-width!,border-right-width!,border-bottom-width!,border-left-width!,border-top-style!,border-right-style!,border-bottom-style!,border-left-style!,border-top-color!,border-right-color!,border-bottom-color!,border-left-color!,border-image-source!,border-image-slice!,border-image-width!,border-image-outset!,border-image-repeat!]
    - _0tu9g5d._.css | :root.theme-mid .chat-inputbar .chat-send-btn::before → [border-top-left-radius,border-top-right-radius,border-bottom-right-radius,border-bottom-left-radius,opacity,background-image!,background-position-x!,background-position-y!,background-size!,background-repeat!,background-attachment!,background-origin!,background-clip!,background-color!]
  - focus-visible:
    - _0blu2ae._.css | :where(a, button, input, select, textarea, [role], [tab… → [outline-color]
  - active:
    - _0tu9g5d._.css | :root.theme-light .chat-inputbar .chat-listen-btn:activ… → [background-image,background-position-x,background-position-y,background-size,background-repeat,background-attachment,background-origin,background-clip,background-color,border-top-color,border-top-style,border-top-width,border-right-color,border-right-style,border-right-width,border-bottom-color,border-bottom-style,border-bottom-width,border-left-color,border-left-style,border-left-width,border-image-source,border-image-slice,border-image-width,border-image-outset,border-image-repeat,box-shadow]
...
- **<button>** [visible] semantic: `chat-listen-btn pointer-events-auto chat-dictate-btn`
  - tailwind (22): `relative z-[2] !h-[calc(var(--inputbar-h)-2px)] !w-[calc(var(--inputbar-h)-2px)] !min-h-[calc(var(--inputbar-…`
  - computed: color=rgb(47, 58, 74) · borderTopColor=rgb(47, 58, 74) · borderTopLeftRadius=9999px · minHeight=47.28px · opacity=1 · outlineColor=rgb(47, 58, 74) · position=relative · visibility=visible
  - tokens: --btn-primary-bg=radial-gradient(92% 88% at 50% 16… · --btn-primary-bg-hover=radial-gradient(92% 88% at 50% 16… · --btn-primary-text=#2f3a4a · --btn-primary-shadow=0 6px 14px #2618161a,
    inset 0… · --btn-primary-border=transparent
  - dead@state: `pointer-events-auto chat-dictate-btn`
  - resting:
    ...
    - _0tu9g5d._.css | :root.theme-light .chat-inputbar .chat-listen-btn → [box-shadow,background-image,background-position-x,background-position-y,background-size,background-repeat,background-attachment,background-origin,background-clip,background-color,border-top-width,border-right-width,border-bottom-width,border-left-width,border-top-style,border-right-style,border-bottom-style,border-left-style,border-top-color,border-right-color,border-bottom-color,border-left-color,border-image-source,border-image-slice,border-image-width,border-image-outset,border-image-repeat]
    - _0tu9g5d._.css | :root.theme-mid .chat-inputbar, :root.theme-mid .chat-i… → [--chat-action-size,color,--chat-inputbar-bg,--chat-inputbar-bg-hover,--chat-inputbar-bg-focus,--chat-inputbar-overlay-bg,--chat-inputbar-shadow,--chat-inputbar-shadow-hover,--chat-inputbar-shadow-focus,--chat-inputbar-btn-bg,--chat-inputbar-btn-bg-hover,--chat-inputbar-btn-bg-focus,--chat-inputbar-btn-overlay-bg,--chat-inputbar-btn-shadow,--chat-inputbar-btn-shadow-hover,--chat-inputbar-btn-shadow-focus]
    - _0tu9g5d._.css | :root.theme-mid .chat-inputbar .chat-listen-btn → [box-shadow!,background-image!,background-position-x!,background-position-y!,background-size!,background-repeat!,background-attachment!,background-origin!,background-clip!,background-color!,border-top-width!,border-right-width!,border-bottom-width!,border-left-width!,border-top-style!,border-right-style!,border-bottom-style!,border-left-style!,border-top-color!,border-right-color!,border-bottom-color!,border-left-color!,border-image-source!,border-image-slice!,border-image-width!,border-image-outset!,border-image-repeat!]
  - focus-visible:
    - _0blu2ae._.css | :where(a, button, input, select, textarea, [role], [tab… → [outline-color]
  - active:
    - _0tu9g5d._.css | :root.theme-light .chat-inputbar .chat-listen-btn:activ… → [background-image,background-position-x,background-position-y,background-size,background-repeat,background-attachment,background-origin,background-clip,background-color,border-top-color,border-top-style,border-top-width,border-right-color,border-right-style,border-right-width,border-bottom-color,border-bottom-style,border-bottom-width,border-left-color,border-left-style,border-left-width,border-image-source,border-image-slice,border-image-width,border-image-outset,border-image-repeat,box-shadow]
...
- **<button>** [hidden] semantic: `button ui-glow-button-frame ui-glow-button-control invite-primary-btn` · modules: BorderGlow-module
  - tailwind (76): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(82% 66% at 50% -1… · color=rgb(236, 235, 233) · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0.13) 0px 4px 10px … · borderTopLeftRadius=999px · minHeight=38.72px · opacity=1 · transform=matrix3d(1, 0, 0, 0, 0, 1, 0, 0, … · outlineColor=rgb(236, 235, 233) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=hidden
...
- **<button>** [visible, disabled] semantic: `chat-send-btn invite-primary-btn pointer-events-auto`
  - tailwind (22): `relative z-[2] !h-[calc(var(--inputbar-h)-2px)] !w-[calc(var(--inputbar-h)-2px)] !min-h-[calc(var(--inputbar-…`
  - computed: backgroundImage=radial-gradient(82% 66% at 50% -1… · color=rgba(255, 255, 255, 0.3) · boxShadow=rgba(255, 255, 255, 0.06) 0px 1px… · borderTopLeftRadius=9999px · minHeight=47.28px · opacity=1 · transform=matrix(1, 0, 0, 1, 0, 0) · outlineColor=rgba(255, 255, 255, 0.3) · position=relative · visibility=visible
...
- **<button>** [visible] semantic: `chat-listen-btn pointer-events-auto chat-dictate-btn`
  - tailwind (22): `relative z-[2] !h-[calc(var(--inputbar-h)-2px)] !w-[calc(var(--inputbar-h)-2px)] !min-h-[calc(var(--inputbar-…`
  - computed: color=rgb(255, 255, 255) · borderTopLeftRadius=9999px · minHeight=47.28px · opacity=1 · outlineColor=rgb(255, 255, 255) · position=relative · visibility=visible
  - tokens: --btn-primary-bg=radial-gradient(82% 66% at 50% -1… · --btn-primary-bg-hover=radial-gradient(82% 66% at 50% -1… · --btn-primary-text=#f8fcfff5 · --btn-primary-shadow=inset 0 1px 0 #ffffff0f,
    0 5p… · --btn-primary-border=0 solid transparent
  - dead@state: `pointer-events-auto`
  - resting:
    - _0tu9g5d._.css | body .chat-inputbar .chat-listen-btn, body .chat-inputb… → [border-top-left-radius!,border-top-right-radius!,border-bottom-right-radius!,border-bottom-left-radius!]
    - _0tu9g5d._.css | :root:not(.theme-light):not(.theme-mid) .chat-inputbar … → [box-shadow,background-image,background-position-x,background-position-y,background-size,background-repeat,background-attachment,background-origin,background-clip,background-color,border-top-width,border-right-width,border-bottom-width,border-left-width,border-top-style,border-right-style,border-bottom-style,border-left-style,border-top-color,border-right-color,border-bottom-color,border-left-color,border-image-source,border-image-slice,border-image-width,border-image-outset,border-image-repeat]
  - focus-visible:
    - _0blu2ae._.css | :where(a, button, input, select, textarea, [role], [tab… → [outline-color]
...
- **<button>** [visible, disabled] semantic: `chat-send-btn invite-primary-btn pointer-events-auto`
  - tailwind (22): `relative z-[2] !h-[calc(var(--inputbar-h)-2px)] !w-[calc(var(--inputbar-h)-2px)] !min-h-[calc(var(--inputbar-…`
  - computed: backgroundImage=radial-gradient(82% 66% at 50% -1… · color=rgba(255, 255, 255, 0.3) · boxShadow=rgba(220, 236, 255, 0.1) 0px 1px … · borderTopLeftRadius=9999px · minHeight=47.28px · opacity=1 · transform=matrix(1, 0, 0, 1, 0, 0) · outlineColor=rgba(255, 255, 255, 0.3) · position=relative · visibility=visible
...
- **<button>** [hidden] semantic: `button ui-glow-button-frame ui-glow-button-control invite-primary-btn` · modules: BorderGlow-module
  - tailwind (76): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundImage=radial-gradient(118% 102% at 50% … · color=rgba(230, 230, 230, 0.96) · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0.13) 0px 4px 10px … · borderTopLeftRadius=999px · minHeight=38.72px · opacity=1 · transform=matrix3d(1, 0, 0, 0, 0, 1, 0, 0, … · outlineColor=rgba(230, 230, 230, 0.96) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=hidden
  ...
  - hover Δ: color=rgba(216, 165, 165, 0.99) · boxShadow=rgba(0, 0, 0, 0.114) 0px 5.40591p… · outlineColor=rgba(216, 165, 165, 0.99)
  ...
  - resting:
    ...
    - _0tu9g5d._.css | :root.theme-mono:not([data-contrast="hc"]) .drawer-pane… → [color!,background-image!,background-position-x!,background-position-y!,background-size!,background-repeat!,background-attachment!,background-origin!,background-clip!,background-color!,border-top-color!,border-top-style!,border-top-width!,border-right-color!,border-right-style!,border-right-width!,border-bottom-color!,border-bottom-style!,border-bottom-width!,border-left-color!,border-left-style!,border-left-width!,border-image-source!,border-image-slice!,border-image-width!,border-image-outset!,border-image-repeat!,box-shadow!]
    - _0tu9g5d._.css | :root.theme-mono:not([data-contrast="hc"]) .drawer-pane… → [background-image!,background-position-x!,background-position-y!,background-size!,background-repeat!,background-attachment!,background-origin!,background-clip!,background-color!]
    - _0tu9g5d._.css | .BorderGlow-module__FDv2aW__card → [--edge-proximity,--cursor-angle,--edge-sensitivity,--color-sensitivity,--border-radius,--glow-padding,--cone-spread,border-top-left-radius,border-top-right-radius,border-bottom-right-radius,border-bottom-left-radius,background-image,background-position-x,background-position-y,background-size,background-repeat,background-attachment,background-origin,background-clip,background-color]
    - _0tu9g5d._.css | .BorderGlow-module__FDv2aW__card::before, .BorderGlow-m… → [border-top-left-radius,border-top-right-radius,border-bottom-right-radius,border-bottom-left-radius]
    - _0tu9g5d._.css | .BorderGlow-module__FDv2aW__card::before → [background-image,background-position-x,background-position-y,background-size,background-repeat,background-attachment,background-origin,background-clip,background-color,opacity,border-top-width,border-right-width,border-bottom-width,border-left-width,border-top-style,border-right-style,border-bottom-style,border-left-style,border-top-color,border-right-color,border-bottom-color,border-left-color,border-image-source,border-image-slice,border-image-width,border-image-outset,border-image-repeat]
    - _0tu9g5d._.css | .BorderGlow-module__FDv2aW__card::after → [background-image,background-position-x,background-position-y,background-size,background-repeat,background-attachment,background-origin,background-clip,background-color,opacity,border-top-width,border-right-width,border-bottom-width,border-left-width,border-top-style,border-right-style,border-bottom-style,border-left-style,border-top-color,border-right-color,border-bottom-color,border-left-color,border-image-source,border-image-slice,border-image-width,border-image-outset,border-image-repeat]
...
- **<button>** [visible, disabled] semantic: `chat-send-btn invite-primary-btn pointer-events-auto`
  - tailwind (22): `relative z-[2] !h-[calc(var(--inputbar-h)-2px)] !w-[calc(var(--inputbar-h)-2px)] !min-h-[calc(var(--inputbar-…`
  - computed: backgroundImage=radial-gradient(118% 102% at 50% … · color=rgba(230, 230, 230, 0.96) · boxShadow=rgba(214, 214, 214, 0.08) 0px 1px… · borderTopLeftRadius=9999px · minHeight=47.28px · opacity=1 · transform=matrix(1, 0, 0, 1, 0, 0) · outlineColor=rgba(230, 230, 230, 0.96) · position=relative · visibility=visible
  ...
  - resting:
    ...
    - _0tu9g5d._.css | body .chat-inputbar .chat-listen-btn, body .chat-inputb… → [border-top-left-radius!,border-top-right-radius!,border-bottom-right-radius!,border-bottom-left-radius!]
    - _0tu9g5d._.css | :root:not(.theme-light):not(.theme-mid) .chat-inputbar … → [border-top-color,border-top-style,border-top-width,border-right-color,border-right-style,border-right-width,border-bottom-color,border-bottom-style,border-bottom-width,border-left-color,border-left-style,border-left-width,border-image-source,border-image-slice,border-image-width,border-image-outset,border-image-repeat,background-image,background-position-x,background-position-y,background-size,background-repeat,background-attachment,background-color,box-shadow,background-origin,background-clip]
    - _0tu9g5d._.css | :root.theme-mono:not([data-contrast="hc"]) :is(.chat-ra… → [color!]
    - _0tu9g5d._.css | :root.theme-mono:not([data-contrast="hc"]) body .chat-i… → [border-top-color!,border-right-color!,border-bottom-color!,border-left-color!]
  - focus-visible:
    - _0blu2ae._.css | :where(a, button, input, select, textarea, [role], [tab… → [outline-color]
  - active:
    - _0blu2ae._.css | :root:not(.theme-light):not(.theme-mid) .invite-primary… → [opacity!]
...
- **<button>** [visible] semantic: `chat-listen-btn pointer-events-auto chat-dictate-btn`
  - tailwind (22): `relative z-[2] !h-[calc(var(--inputbar-h)-2px)] !w-[calc(var(--inputbar-h)-2px)] !min-h-[calc(var(--inputbar-…`
  - computed: color=rgb(197, 113, 113) · borderTopLeftRadius=9999px · minHeight=47.28px · opacity=1 · outlineColor=rgb(197, 113, 113) · position=relative · visibility=visible
  - tokens: --btn-primary-bg=radial-gradient(118% 102% at 50% … · --btn-primary-bg-hover=radial-gradient(118% 102% at 50% … · --btn-primary-text=#e6e6e6f5 · --btn-primary-shadow=inset 0 1px 0 #d6d6d614,
    0 5p… · --btn-primary-border=0 solid transparent
  - dead@state: `pointer-events-auto`
  - resting:
...
- **<button>** [visible, disabled] semantic: `chat-send-btn invite-primary-btn pointer-events-auto`
  ...
  - resting:
    ...
    - _0tu9g5d._.css | body .chat-inputbar .chat-listen-btn, body .chat-inputb… → [border-top-left-radius!,border-top-right-radius!,border-bottom-right-radius!,border-bottom-left-radius!]
    - _0tu9g5d._.css | html[data-contrast="hc"] body .chat-inputbar .chat-send… → [--btn-primary-bg,--btn-primary-bg-hover,--btn-primary-bg-active,--btn-primary-border,--btn-primary-border-hover,--btn-primary-border-active,--btn-primary-shadow,--btn-primary-shadow-hover,--btn-primary-shadow-active,--btn-primary-shadow-focus,--btn-primary-focus-ring-color,--btn-primary-text,box-shadow!,backdrop-filter!,background-image!,background-position-x!,background-position-y!,background-size!,background-repeat!,background-attachment!,background-origin!,background-clip!,background-color!]
    - _0tu9g5d._.css | :root:not(.theme-light):not(.theme-mid) .chat-inputbar … → [border-top-color,border-top-style,border-top-width,border-right-color,border-right-style,border-right-width,border-bottom-color,border-bottom-style,border-bottom-width,border-left-color,border-left-style,border-left-width,border-image-source,border-image-slice,border-image-width,border-image-outset,border-image-repeat,background-image,background-position-x,background-position-y,background-size,background-repeat,background-attachment,background-color,box-shadow,background-origin,background-clip]
  - focus-visible:
    - _0blu2ae._.css | :where(a, button, input, select, textarea, [role], [tab… → [outline-color]
  - active:
    - _0blu2ae._.css | :root:not(.theme-light):not(.theme-mid) .invite-primary… → [opacity!]
    - _0tu9g5d._.css | html[data-contrast="hc"] body .chat-inputbar .chat-send… → [--btn-primary-bg,--btn-primary-border,--btn-primary-shadow]
...
- **<button>** [visible] semantic: `chat-listen-btn pointer-events-auto chat-dictate-btn`
  ...
  - resting:
    - _0tu9g5d._.css | body .chat-inputbar .chat-listen-btn, body .chat-inputb… → [border-top-left-radius!,border-top-right-radius!,border-bottom-right-radius!,border-bottom-left-radius!]
    - _0tu9g5d._.css | html[data-contrast="hc"] body .chat-inputbar .chat-list… → [box-shadow!,background-image!,background-position-x!,background-position-y!,background-size!,background-repeat!,background-attachment!,background-origin!,background-clip!,background-color!,border-top-width!,border-right-width!,border-bottom-width!,border-left-width!,border-top-style!,border-right-style!,border-bottom-style!,border-left-style!,border-top-color!,border-right-color!,border-bottom-color!,border-left-color!,border-image-source!,border-image-slice!,border-image-width!,border-image-outset!,border-image-repeat!]
    - _0tu9g5d._.css | :root:not(.theme-light):not(.theme-mid) .chat-inputbar … → [box-shadow,background-image,background-position-x,background-position-y,background-size,background-repeat,background-attachment,background-origin,background-clip,background-color,border-top-width,border-right-width,border-bottom-width,border-left-width,border-top-style,border-right-style,border-bottom-style,border-left-style,border-top-color,border-right-color,border-bottom-color,border-left-color,border-image-source,border-image-slice,border-image-width,border-image-outset,border-image-repeat]
    - _0tu9g5d._.css | html[data-contrast="hc"] body :is(.chat-inputbar .chat-… → [--btn-border-idle,--btn-border-glow,box-shadow,border-top-color,border-right-color,border-bottom-color,border-left-color,background-image!,background-position-x!,background-position-y!,background-size!,background-repeat!,background-attachment!,background-origin!,background-clip!,background-color!]
  - focus-visible:
    - _0blu2ae._.css | :where(a, button, input, select, textarea, [role], [tab… → [outline-color]
