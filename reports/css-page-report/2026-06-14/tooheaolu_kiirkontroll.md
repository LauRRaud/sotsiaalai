# /tooheaolu/kiirkontroll — primitive CSS report
...
- **<button>** [visible] semantic: `button ui-glow-button-frame ui-glow-button-control` · modules: BorderGlow-module
  ...
  - hover Δ: color=rgba(214, 158, 158, 0.992) · boxShadow=rgba(0, 0, 0, 0.114) 0px 5.55173p… · outlineColor=rgba(214, 158, 158, 0.992)
