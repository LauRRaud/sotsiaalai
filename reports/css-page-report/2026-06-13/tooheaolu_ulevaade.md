...
- **<button>** [visible] semantic: `button shadow-none`
  - tailwind (42): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundColor=rgba(255, 255, 255, 0.04) · color=rgba(0, 0, 0, 0.94) · borderTopWidth=0.8px · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0) 0px 0px 0px 0px,… · borderTopLeftRadius=12.16px · minHeight=38.72px · opacity=1 · outlineColor=rgba(0, 0, 0, 0.94) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
  - tokens: --btn-primary-bg=radial-gradient(92% 88% at 50% 16… · --btn-primary-bg-hover=radial-gradient(92% 88% at 50% 16… · --btn-primary-text=#243244 · --btn-primary-shadow=0 4px 10px #00000021 · --btn-primary-border=0 solid transparent
  - resting:
    - components_0b3d-an._.css | .WellbeingPage-module__RRRxDq__page .button[data-varian… → [color!]
    - components_0b3d-an._.css | .WellbeingPage-module__RRRxDq__supportActions .button → [border-top-left-radius!,border-top-right-radius!,border-bottom-right-radius!,border-bottom-left-radius!]
...
- **<button>** [visible] semantic: `button shadow-none`
  - tailwind (42): `inline-flex items-center justify-center gap-[0.45rem] rounded-full border border-solid border-transparent px-…`
  - computed: backgroundColor=rgba(255, 255, 255, 0.04) · color=rgba(255, 255, 255, 0.95) · borderTopWidth=0.8px · borderTopStyle=solid · boxShadow=rgba(0, 0, 0, 0) 0px 0px 0px 0px,… · borderTopLeftRadius=12.16px · minHeight=38.72px · opacity=1 · outlineColor=rgba(255, 255, 255, 0.95) · backdropFilter=blur(10px) saturate(1.2) · position=relative · visibility=visible
  - tokens: --btn-primary-bg=radial-gradient(82% 66% at 50% -1… · --btn-primary-bg-hover=radial-gradient(82% 66% at 50% -1… · --btn-primary-text=#243244 · --btn-primary-shadow=0 4px 10px #00000021 · --btn-primary-border=0 solid transparent
  - resting:
    - components_0b3d-an._.css | .WellbeingPage-module__RRRxDq__page .button[data-varian… → [color!]
    - components_0b3d-an._.css | .WellbeingPage-module__RRRxDq__supportActions .button → [border-top-left-radius!,border-top-right-radius!,border-bottom-right-radius!,border-bottom-left-radius!]
