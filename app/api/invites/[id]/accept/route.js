...
export async function POST(req, {
  ...
  const rawDisplayName = typeof payload?.display_name === "string" ? payload.display_name : typeof payload?.displayName === "string" ? payload.displayName : "";
