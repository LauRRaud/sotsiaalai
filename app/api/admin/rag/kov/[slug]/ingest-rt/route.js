import { ingestKovRtEntryBySlug } from "@/lib/admin/rag/kov/service";
...
export async function POST(request, { params }) {
  ...
  try {
    ...
    console.error("[kov-admin] rt ingest failed", { slug, error: safeError(error) });
    return json(
      {
        ok: false,
        message: String(error?.message || "RT ingest failed"),
