...
const shellClassName = "mx-auto my-[clamp(1.4rem,3vw,2.4rem)] flex w-[min(100%,92vw)] max-w-[clamp(56rem,86vw,84rem)] flex-col gap-[0.9em] rounded-[1.5em] bg-[color:var(--glass-surface-bg)] px-[clamp(1.8rem,3.6vw,2.6rem)] pt-[clamp(0.8rem,2.2vw,1.2rem)] pb-[clamp(1.2rem,3.4vw,2rem)] text-[1.12rem] text-[color:var(--admin-text)] backdrop-blur-[var(--glass-blur-radius)] [--rag-text:var(--admin-text)] [--rag-muted:var(--admin-muted)] max-md:w-full max-md:max-w-none max-md:rounded-none max-md:my-0 max-md:px-[clamp(1rem,4vw,1.5rem)] max-md:pt-[calc(env(safe-area-inset-top,0px)+2.6rem)] max-md:pb-[clamp(2rem,8vw,2.9rem)]";
