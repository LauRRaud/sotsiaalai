...
test("BorderGlow keeps the mesh border edge-only and pointer-driven edge light", () => {
  ...
  assert.match(borderGlowCss, /--edge-only-hot-end,\s*6%/);
  assert.match(borderGlowCss, /--edge-only-fade-end,\s*24%/);
  assert.match(borderGlowCss, /--edge-only-gap-start,\s*32%/);
  assert.match(borderGlowCss, /--edge-only-return-start,\s*50%/);
  assert.match(borderGlowCss, /--edge-only-return-bright,\s*86%/);
