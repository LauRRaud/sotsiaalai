...
test("service map markers use flat 2D drop-shaped icon backgrounds", () => {
  ...
  assert.match(markerLabelBlock, /color:\s*currentColor/);
  assert.match(markerBlock, /--service-map-marker-label-x:\s*50%/);
  assert.match(markerBlock, /--service-map-marker-label-y:\s*35\.84%/);
  assert.match(markerLabelBlock, /top:\s*var\(--service-map-marker-label-y\)/);
  assert.match(markerLabelBlock, /left:\s*var\(--service-map-marker-label-x\)/);
  assert.match(markerLabelBlock, /transform:\s*translate\(-50%,\s*-50%\)/);
  assert.doesNotMatch(markerLabelBlock, /rotate\(45deg\)/);
  assert.match(kovMarkerBlock, /--service-map-marker-fill:\s*#2f5f8f/);
  assert.match(kovMarkerBlock, /--service-map-marker-label-x:\s*50\.18%/);
  assert.match(kovMarkerBlock, /--service-map-marker-label-y:\s*39\.25%/);
  assert.match(providerMarkerBlock, /--service-map-marker-fill:\s*#168a72/);
  assert.match(providerMarkerBlock, /--service-map-marker-label-x:\s*50\.24%/);
  assert.match(providerMarkerBlock, /--service-map-marker-label-y:\s*39\.75%/);
